...
Сценарий: Инициализация переменных
	...
	И Я запоминаю значение выражения 'ИдентификацияПродуктаУХКлиентСервер.ЭтоPerform()' в переменную '$$ЭтоPerform$$'
...
Сценарий: Я в списке 'TheListName' по полю 'TheField' ищу элемент 'ThePattern' 'TheCompareType' 
	...
	И я жду открытия формы '[TheListName]' в течение 10 секунд
