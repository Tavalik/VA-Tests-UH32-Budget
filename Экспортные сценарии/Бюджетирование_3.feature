...
Сценарий: Движения документа стали равны "ThePath" область чтения "TheCell"
	...
	Если элемент формы с именем 'Флажок1' имеет значение 'Да' Тогда
		...
		И я жду когда в табличном документе 'ОтчетТабличныйДокумент' заполнится ячейка 'R2C1' в течение 60 секунд
	И в табличном документе 'ОтчетТабличныйДокумент' я перехожу к ячейке "[TheCell]"
	И Я задаю параметры чтения области макета "[TheCell]"
...
Сценарий: Движения документа с реквизитами стали равны "ThePath" область чтения "TheCell"
