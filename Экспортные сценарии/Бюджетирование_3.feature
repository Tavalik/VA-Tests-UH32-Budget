...
Сценарий: Я ввожу комментарий 'TheComment' в ячейку 'TheCellAddress'

	И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке '[TheCellAddress]'
	Если текущее окно имеет заголовок "Экземпляр отчета*" Тогда
		И я нажимаю на кнопку с именем 'ПолеТабличногоДокументаМакетКомментироватьПоказатель'
	ИначеЕсли текущее окно имеет заголовок "Сводная таблица*" Тогда
