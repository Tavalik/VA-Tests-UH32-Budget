...
Сценарий: 19.08 Настройка процесса
	...
	* Этап "Обработка"
		...
		Когда открылось окно "Обработка универсального процесса (Этап универсального процесса) *"
...
Сценарий: 19.09 Созданеие сценария и документа управления отчетным периодом
	...
	* Создаем новый документ управления отчетным периодом
		* Основная вкладка
			...
			И в поле с именем 'ДатаНачалаПроцесса' я ввожу текст '01.01.2024  0:00:00'
		...
		* Кнопки открытия обработок управления процессом
			* Управление процессом подготовки отчетности (таблица)
			...
			* Ход выполнения процесса подготовки отчетности	
				...
				Когда открылось окно "Ход выполнения процесса подготовки отчетности"
				Тогда элемент формы с именем 'УправлениеПериодом' стал равен '$ЗаголовокОкна$'
				И Я закрываю окно "Ход выполнения процесса подготовки отчетности"				
			* Матрица отчетов
				Тогда открылось окно '$ЗаголовокОкна$'
				И я нажимаю на кнопку с именем 'УправлениеПроцессом_Документ1'
	...
	* Кнопки открытия обработок управления процессом		
		* Управление процессом подготовки отчетности (таблица)
			...
			И я нажимаю на кнопку с именем 'ФормаУправлениеПроцессом_Таблица'
			Тогда открылось окно "Управление процессом подготовки отчетности (таблица)"
			Тогда элемент формы с именем 'УправлениеПериодом' стал равен '$ЗаголовокОкна$'
			Тогда таблица 'ДеревоЭтапы' стала равной:
				| "Этап/Организация"                               | "Состояние этапа" |
		...
		* Ход выполнения процесса подготовки отчетности
			Когда открылось окно "Управление отчетным периодом"
			И я нажимаю на кнопку с именем 'ФормаУправлениеПроцессом_Диаграмма'
			Когда открылось окно "Ход выполнения процесса подготовки отчетности"
			Тогда элемент формы с именем 'УправлениеПериодом' стал равен '$ЗаголовокОкна$'
			И Я закрываю окно "Ход выполнения процесса подготовки отчетности"
		* Матрица отчетов
			Когда открылось окно "Управление отчетным периодом"
			И я нажимаю на кнопку с именем 'ФормаУправлениеПроцессом_Матрица'
			Когда открылось окно "Матрица отчетов"
			Тогда элемент формы с именем 'УправлениеПериодом' стал равен '$ЗаголовокОкна$'
			И Я закрываю окно "Матрица отчетов"
...
Сценарий: 19.10 Ход выполнения процесса подготовки отчетности

	И В командном интерфейсе я выбираю "Процессы и согласование" "Диаграмма управления процессом"
	Когда открылось окно "Ход выполнения процесса подготовки отчетности"

	* Останавливаем и останавливаем процесс
