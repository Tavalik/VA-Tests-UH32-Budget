...
Сценарий: 19.06 Создание регламента и процесса подготовки отчетности "ВА - Процесс подготовки отчетности"
...
Сценарий: 19.08 Настройка процесса
	...
	* Этап "Оповещение"
		Когда открылось окно "Редактирование этапов процесса: ВА - Процесс подготовки отчетности"
		И я нажимаю на кнопку с именем 'ДобавитьЭтап_Оповещение'
		Тогда открылось окно "Оповещение (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Оповещение - После ручных этапов"
		...
		И в таблице 'Адресаты' я начинаю редактирование строки	
		...
		Тогда открылось окно "Оповещение (Этап универсального процесса) *"	
		И я перехожу к закладке с именем 'РедактированиеШаблона'
		И я помещаю в буфер обмена строку "Выполнены расчеты по сценарию [Параметр.Сценарий] и регламенту [Параметр.ВерсияОрганизационнойСтруктуры]."
		И я нажимаю на кнопку с именем 'ШаблонОповещенияВставитьИзБуфераОбмена'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "Оповещение (Этап универсального процесса) *" в течение 20 секунд			

	* Этап "Обработка"
		Когда открылось окно "Редактирование этапов процесса: ВА - Процесс подготовки отчетности"
		И я нажимаю на кнопку с именем 'ДобавитьЭтап_ОбработкаУниверсальногоПроцесса'
		Тогда открылось окно "Обработка универсального процесса (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Обработка - Обработка этапа"
		И я нажимаю на кнопку с именем 'ПерейтиВРедактированиеПроцедуры'
		Тогда открылось окно "Редактирование текста процедуры"
		И в поле с именем 'ТекстПроцедуры' я ввожу текст "Сообщить(\"Обработка универсального процесса выполнена!\");"
		И я нажимаю на кнопку с именем 'ФормаПрименить'
		Тогда открылось окно "Обработка универсального процесса (Этап универсального процесса) *"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "Обработка универсального процесса (Этап универсального процесса) *" в течение 20 секунд
	...
	* Настраиваем связи
		...
		И Я в списке "Выберите конечный этап связи" по полю "Наименование" ищу и выбираю элемент "Оповещение - После ручных этапов" "По точному совпадению"	
		И я нажимаю на кнопку с именем 'ДобавитьСвязь'
		И Я в списке "Выберите начальный этап связи" по полю "Наименование" ищу и выбираю элемент "Оповещение - После ручных этапов" "По точному совпадению"
		И Я в списке "Выберите конечный этап связи" по полю "Наименование" ищу и выбираю элемент "Обработка - Обработка этапа" "По точному совпадению"	
		И я нажимаю на кнопку с именем 'ДобавитьСвязь'
		И Я в списке "Выберите начальный этап связи" по полю "Наименование" ищу и выбираю элемент "Обработка - Обработка этапа" "По точному совпадению"
...
Сценарий: 19.09 Созданеие сценария и документа управления отчетным периодом
	...
	* Создаем новый документ управления отчетным периодом
		...
		* Настройка отчетов
			...
			Тогда открылось окно "Настройка правил заполнения объектов для регламента ВА - Процесс подготовки отчетности по сценарию ВА - Процесс подготовки отчетности за период Январь *"
			Тогда табличный документ 'ПолеНастройки' равен:
				| "Организация \\ Объект" | ''                    | "ВА - ПроцессСумма"                          | "ВА - ПроцессКоличество"        | "ВА - ПроцессЦена"                                                    |
				| "Система ООО"           | "Отображение отчета"  | "ВА - ПроцессСумма"                          | ''                              | ''                                                                    |
				| ''                      | "Правило расчета"     | "ВА - ПроцессСумма"                          | ''                              | ''                                                                    |
				...
				| ''                      | "Валюта объекта"      | "Из регламента: RUB (EUR, USD)"              | "Из регламента: RUB (EUR, USD)" | "Из регламента: RUB (EUR, USD)"                                       |
				| ''                      | "Шаблон трансляции"   | ''                                           | ''                              | ''                                                                    |
			И Я закрываю окно "Настройка правил заполнения объектов для регламента ВА - Процесс подготовки отчетности по сценарию ВА - Процесс подготовки отчетности за период Январь *"
		* Процесс
			Когда открылось окно '$ЗаголовокОкна$'
			И я нажимаю на кнопку с именем 'ФормаВперед'
			И элемент формы с именем 'ЗапуститьПроцесс' доступен
			И элемент формы с именем 'ПрекратитьПроцесс' не доступен
			И элемент формы с именем 'МатрицаОтчетов' доступен
			И элемент формы с именем 'УправлениеПроцессомПодготовкиОтчетности' не доступен
			И элемент формы с именем 'ДиаграммаПроцессаПодготовкиОтчетности' не доступен			
			...
			И элемент формы с именем 'МатрицаОтчетов' доступен
			И элемент формы с именем 'УправлениеПроцессомПодготовкиОтчетности' доступен
			И элемент формы с именем 'ДиаграммаПроцессаПодготовкиОтчетности' доступен
		...
		* Кнопки открытия обработок управления процессом
			* Матрица отчетов
				...
				Когда открылось окно "Матрица отчетов"
				...
				Иначе
					Тогда табличный документ 'РезультатМатрицаОтчетов' равен:
						...
						| "ВА - ПроцессЦена"                                                                                                         | '' | '' | '' | ''           | 'Х'         | ''             | 'Х'           |
						| "ВА - ПроцессЦена"                                                                                                         | '' | '' | '' | "Нзп"        | ''          | "Нзп"          | ''            |
						| "Консолидация - \"ВА - ПроцессСумма\""                                                                                     | '' | '' | '' | ''           | ''          | ''             | ''            |
						| "ВА - ПроцессСумма"                                                                                                        | '' | '' | '' | 'Х'          | 'Х'         | 'Х'            | ''            |
						| "Расчет по правилу - \"ВА - ПроцессСумма\""                                                                                | '' | '' | '' | ''           | ''          | ''             | ''            |
						| "ВА - ПроцессСумма"                                                                                                        | '' | '' | '' | ''           | 'Х'         | ''             | 'Х'           |
						| "Ручное заполнение - \"ВА - ПроцессКоличество\""                                                                           | '' | '' | '' | ''           | ''          | ''             | ''            |
						| "ВА - ПроцессКоличество"                                                                                                   | '' | '' | '' | ''           | 'Х'         | ''             | 'Х'           |
						| "ВА - ПроцессКоличество"                                                                                                   | '' | '' | '' | "Нзп"        | ''          | "Нзп"          | ''            |
				И Я закрываю окно "Матрица отчетов"
			* Управление процессом подготовки отчетности
				...
				Тогда таблица 'ДеревоЭтапы' стала равной:
					...
					| "Оповещение - После ручных этапов"               | "Не активен"      |
					| "Обработка - Обработка этапа"                    | "Не активен"      |
			...
			* Ход выполнения процесса подготовки отчетности	
				Тогда открылось окно '$ЗаголовокОкна$'	
				И я нажимаю на кнопку с именем 'ДиаграммаПроцессаПодготовкиОтчетности'
				Тогда открылось окно "Диаграмма процесса подготовки отчетности"								
				Тогда элемент формы с именем 'УправлениеПериодом' стал равен '$ЗаголовокОкна$'
				И Я закрываю окно "Диаграмма процесса подготовки отчетности"				
...
Сценарий: 19.10 Диаграмма процесса подготовки отчетности
	...
	И В командном интерфейсе я выбираю "Бюджетирование, отчетность и анализ" "Диаграмма процесса подготовки отчетности"
	Когда открылось окно "Диаграмма процесса подготовки отчетности"

	* Останавливаем процесс
		И элемент формы с именем 'ГруппаПроцессЗапущен' присутствует на форме
		И я нажимаю на кнопку с именем 'ОстановитьПроцесс'
		И элемент формы с именем 'ГруппаПроцессЗапущен' отсутствует на форме
		И я нажимаю на кнопку с именем 'ЗапуститьПроцесс'
		И элемент формы с именем 'ГруппаПроцессЗапущен' присутствует на форме		

	* Включаем сообщения
		Тогда открылось окно "Диаграмма процесса подготовки отчетности"
		Если у элемента формы с именем 'ВыводитьСообщения' не установлена пометка Тогда
			И я нажимаю на кнопку с именем 'ВыводитьСообщения'

	* Обрабатываем один этап

		* Создание документов этапа
			Когда открылось окно "Диаграмма процесса подготовки отчетности"		
			И я нажимаю на кнопку с именем 'СоздатьДокументыЭтапа'
			Тогда открылось окно "Выберите этап для обработки"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование"                  | "Тип этапа"                           |
				| "Импорт - \"ВА - ПроцессЦена\"" | "Этап процесса подготовки отчетности" |
			И в таблице 'Список' я выбираю текущую строку			
		
		* Обработка этапа
			Тогда открылось окно "Диаграмма процесса подготовки отчетности"
			И я нажимаю на кнопку с именем 'ОбработатьЭтап'
			Тогда открылось окно "Выберите этап для обработки"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование"                  | "Тип этапа"                           |
				| "Импорт - \"ВА - ПроцессЦена\"" | "Этап процесса подготовки отчетности" |
			...
			Тогда в логе сообщений TestClient есть строки по шаблону:
				|"Заполнен документ \"Экземпляр отчета *\""|
				|"Заполнен документ \"Экземпляр отчета *\""|
			И я очищаю окно сообщений пользователю
		
		* Обработка этапа до текущего
			Когда открылось окно "Диаграмма процесса подготовки отчетности"
			И я нажимаю на кнопку с именем 'ОбработатьИЗавершитьЭтапыДоТекущего'
			Тогда открылось окно "Выберите этап для обработки"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование"                  | "Тип этапа"                           |
				| "Импорт - \"ВА - ПроцессЦена\"" | "Этап процесса подготовки отчетности" |
			...
			Тогда в логе сообщений TestClient есть строки по шаблону:
				|"Заполнен документ \"Экземпляр отчета *\""|
				|"Документ \"Экземпляр отчета *\" переведен в состояние \"Утвержден\""|
				|"Заполнен документ \"Экземпляр отчета *\""|
				|"Документ \"Экземпляр отчета *\" переведен в состояние \"Утвержден\""|
			И я очищаю окно сообщений пользователю	
		...
		* Отмена обработки этапа
			Когда открылось окно "Диаграмма процесса подготовки отчетности"
			И я нажимаю на кнопку с именем 'ОтменитьОбработкуЭтапа'
			Тогда открылось окно "Выберите этап для обработки"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование"                  | "Тип этапа"                           |
				| "Импорт - \"ВА - ПроцессЦена\"" | "Этап процесса подготовки отчетности" |
			...
			Тогда в логе сообщений TestClient есть строки по шаблону:
				|"Документ \"Экземпляр отчета *\" переведен в состояние \"Черновик\""|
				|"Этап \"Импорт - \"ВА - ПроцессЦена\"\" переведен в состояние \"Не открыт\""|
				|"Документ \"Экземпляр отчета *\" переведен в состояние \"Черновик\""|
				|"Этап \"Импорт - \"ВА - ПроцессЦена\"\" переведен в состояние \"Не открыт\""|
			И я очищаю окно сообщений пользователю
		...
		* Завершаем этап по одной организации
			Когда открылось окно "Диаграмма процесса подготовки отчетности"
			И я нажимаю на кнопку с именем 'ЗавершитьОбработкуЭтапа'
			Тогда открылось окно "Выберите этап для обработки"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование"                  | "Тип этапа"                           |
				| "Импорт - \"ВА - ПроцессЦена\"" | "Этап процесса подготовки отчетности" |
			...
			И в таблице 'ТаблицаПериодовСценариев' я перехожу к строке:
				| "Выбран" | "Организация"  |
				| "Нет"    | "Меркурий ООО" |						
			И в таблице 'ТаблицаПериодовСценариев' я изменяю флаг с именем 'ТаблицаПериодовСценариевВыбран'
	...
	* Проверяем состояние процесса
		Когда открылось окно "Диаграмма процесса подготовки отчетности"
		И я нажимаю на кнопку с именем 'ОткрытьУправлениеПроцессомПодготовкиОтчетности'
		Тогда открылось окно "Управление процессом подготовки отчетности"
...
//		Иначе
		Тогда таблица 'ДеревоЭтапы' содержит "18" строк из списка:
			| "Этап/Организация"                               | "Актуальный этап"                                | "Состояние этапа" | "Прогресс операций" |
			| "Ручное заполнение - \"ВА - ПроцессКоличество\"" | ""                                               | "Не активен"      | ""                  |
			| "Система ООО"                                    | ""                                               | "Не активен"      | ""                  |
			| "Венера ООО"                                     | "Импорт - \"ВА - ПроцессЦена\""                  | "Не активен"      | ""                  |
			| "Меркурий ООО"                                   | "Ручное заполнение - \"ВА - ПроцессКоличество\"" | "Не активен"      | ""                  |
			| "Импорт - \"ВА - ПроцессЦена\""                  | ""                                               | "В обработке"     | "50,00"             |
			| "Система ООО"                                    | ""                                               | "В обработке"     | "50,00"             |
			| "Венера ООО"                                     | "Импорт - \"ВА - ПроцессЦена\""                  | "Не активен"      | ""                  |
			| "Меркурий ООО"                                   | "Ручное заполнение - \"ВА - ПроцессКоличество\"" | "Завершен"        | "100,00"            |
			| "Расчет по правилу - \"ВА - ПроцессСумма\""      | ""                                               | "Не активен"      | ""                  |
			| "Система ООО"                                    | ""                                               | "Не активен"      | ""                  |
			| "Венера ООО"                                     | "Импорт - \"ВА - ПроцессЦена\""                  | "Не активен"      | ""                  |
			| "Меркурий ООО"                                   | "Ручное заполнение - \"ВА - ПроцессКоличество\"" | "Не активен"      | ""                  |
			| "Оповещение - После ручных этапов"               | ""                                               | "Не активен"      | ""                  |
			| "<Все организации>"                              | ""                                               | "Не активен"      | ""                  |
			| "Обработка - Обработка этапа"                    | ""                                               | "Не активен"      | ""                  |
			| "<Все организации>"                              | ""                                               | "Не активен"      | ""                  |
			| "Консолидация - \"ВА - ПроцессСумма\""           | ""                                               | "Не активен"      | ""                  |
			| "Система ООО"                                    | "Оповещение - После ручных этапов"               | "Не активен"      | ""                  |
...
Сценарий: 19.11 Ручное заполнение - "ВА - ПроцессКоличество"
	...
	* Останавливаем и запускаем процесс
		...
		И в таблице 'ДеревоЭтапы' я нажимаю на кнопку с именем 'ДеревоЭтапыРазвернутьВсе'
		Тогда таблица 'ДеревоЭтапы' содержит "18" строк из списка:
			| "Этап/Организация"                               | "Состояние этапа" | "Прогресс операций" |
			| "Ручное заполнение - \"ВА - ПроцессКоличество\"" | "Не активен"      | ""                  |
			| "Система ООО"                                    | "Не активен"      | ""                  |
			| "Венера ООО"                                     | "Не активен"      | ""                  |
			| "Меркурий ООО"                                   | "Не активен"      | ""                  |
			| "Импорт - \"ВА - ПроцессЦена\""                  | "Не активен"      | ""                  |
			| "Система ООО"                                    | "Не активен"      | ""                  |
			| "Венера ООО"                                     | "Не активен"      | ""                  |
			| "Меркурий ООО"                                   | "Не активен"      | ""                  |
	...
	* Проверяем результат
		...
		И в таблице 'ДеревоЭтапы' я перехожу к строке:
			| "Этап/Организация"                               | "Состояние этапа" | "Прогресс операций" |
			| "Ручное заполнение - \"ВА - ПроцессКоличество\"" | "Завершен"        | "100,00"            |
...
Сценарий: 19.12 Расчет по правилу - "ВА - ПроцессСумма"
...
Сценарий: 19.13 Импорт - "ВА - ПроцессЦена"	
	...
	* Начинаем обработку этапа
		...
		И я нажимаю на кнопку с именем 'НачатьОбработкуЭтапа'
		Тогда открылось окно "Начать обработку этапа для организаций:"
		И я снимаю флаг с именем 'ЗаполнятьДокументы'				
		И я нажимаю на кнопку с именем 'Выполнить'
	...
	* Проверяем, по организации Меркурий отчет должен быть заполнен
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			| "ВА - ПроцессЦена" | ''                             | ''               | ''                | ''             |
			| ''                 | ''                             | ''               | ''                | ''             |
			| ''                 | "Номенклатура"                 | "Январь 2024 г." | "Февраль 2024 г." | "Март 2024 г." |
			| ''                 | ''                             | "Цена"           | "Цена"            | "Цена"         |
	...
	* Проверяем состояние дерева этапов
		Тогда таблица 'ДеревоЭтапы' стала равной:
			| "Этап/Организация"                               | "Состояние этапа" | "Прогресс операций" |
			| "Ручное заполнение - \"ВА - ПроцессКоличество\"" | "Завершен"        | "100,00"            |
			| "Импорт - \"ВА - ПроцессЦена\""                  | "Завершен"        | "100,00"            |
			| "Расчет по правилу - \"ВА - ПроцессСумма\""      | "Не активен"      | ""                  |
			| "Оповещение - После ручных этапов"               | "Не активен"      | ""                  |
			| "Обработка - Обработка этапа"                    | "Не активен"      | ""                  |
			| "Консолидация - \"ВА - ПроцессСумма\""           | "Не активен"      | ""                  |
			
Сценарий: 19.14 Консолидация - "ВА - ПроцессСумма"
	...
	* Заполняем с утрверждением
		...
		Тогда таблица 'ДеревоЭтапы' стала равной:
			...
			| "Оповещение - После ручных этапов"               | "Завершен"        |
			| "Обработка - Обработка этапа"                    | "Завершен"        |
...
Сценарий: 19.15 Останавливаем процесс
	...
	* Ищем нужный документ
		И В командном интерфейсе я выбираю "Бюджетирование, отчетность и анализ" "Управление отчетным периодом"
		Тогда открылось окно "Управление отчетным периодом"
		И Я в списке "Управление отчетным периодом" по полю "Сценарий" ищу и выбираю элемент "ВА - Процесс подготовки отчетности" "По точному совпадению" 
	...
	* Проверяем результат
		И В командном интерфейсе я выбираю "Бюджетирование, отчетность и анализ" "Управление процессом подготовки отчетности"				
		Тогда открылось окно "Управление процессом подготовки отчетности"
		Тогда элемент формы с именем 'УправлениеПериодом' стал равен по шаблону '$ЗаголовокОкна$'
		И в таблице 'ДеревоЭтапы' я перехожу к строке:
			| "Этап/Организация"                               |
			| "Ручное заполнение - \"ВА - ПроцессКоличество\"" |
		Тогда таблица 'ДеревоОперации' содержит '4' строк из списка:
