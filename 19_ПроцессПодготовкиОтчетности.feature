		...
		* Настройки регламента
			...
			* Меркурий
				...
				Тогда табличный документ 'ПолеНастройки' равен:
					| 'Организация \ Объект' | ''                    | 'ВА - ПроцессКоличество'        |
					| 'Меркурий ООО'         | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Способ формирования' | 'По правилу обработки'          |
					| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD, EUR)' |
					| 'Венера ООО'           | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Способ формирования' | 'По правилу обработки'          |
					| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD, EUR)' |
			...
			* Венера
				Тогда открылось окно "Настройка правил заполнения объектов для регламента ВА - Процесс подготовки отчетности"
				И в табличном документе 'ПолеНастройки' я перехожу к ячейке 'R10C3'
				И в табличном документе 'ПолеНастройки' я делаю двойной клик на текущей ячейке
				Тогда открылось окно "Настройка правил заполнения отчетов"
				И из выпадающего списка с именем 'СпособФормированияОтчета' я выбираю точное значение "Ручное заполнение"
				И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
			* Применение настроек
				...
				Тогда табличный документ 'ПолеНастройки' равен:
					...
					| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Способ формирования' | 'Ручное заполнение'             |
					| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD, EUR)' |
					| 'Венера ООО'           | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        |
					| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        |
...
Сценарий: 19.11 Создание документа управления отчетным периодом		
	...
	* Создаем новый документ управления отчетным периодом
		...
		* Настройка отчетов
			...
			Тогда табличный документ 'ПолеНастройки' равен:
				| 'Организация \ Объект' | ''                    | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| 'Система ООО'          | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Способ формирования' | 'По правилу обработки'          | 'По правилу обработки'                                                | 'Консолидировать периметр (Пропорционально)' |
				| ''                     | 'Валюта объекта'      | 'Из регламента: RUB'            | 'Из регламента: RUB'                                                  | 'Из регламента: RUB'                         |
				| 'Меркурий ООО'         | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Способ формирования' | 'Ручное заполнение'             | 'Импорт\nВнешняя ИБ: ВА - ПроцессИмпортЦена\n(Файлы Microsoft Excel)' | 'По правилу обработки'                       |
				| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD, EUR)' | 'Из регламента: RUB (USD, EUR)'                                       | 'Из регламента: RUB (USD, EUR)'              |
				| 'Венера ООО'           | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Способ формирования' | 'Ручное заполнение'             | 'Импорт\nВнешняя ИБ: ВА - ПроцессИмпортЦена\n(Файлы Microsoft Excel)' | 'По правилу обработки'                       |
				| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD, EUR)' | 'Из регламента: RUB (USD, EUR)'                                       | 'Из регламента: RUB (USD, EUR)'              |
				| 'Земля ООО'            | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Способ формирования' | 'По правилу обработки'          | 'По правилу обработки'                                                | 'По правилу обработки'                       |
				| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD)'      | 'Из регламента: RUB (USD)'                                            | 'Из регламента: RUB (USD)'                   |
				| 'Марс ООО'             | 'Отображение отчета'  | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило обработки'   | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Правило проверки'    | 'ВА - ПроцессКоличество'        | 'ВА - ПроцессЦена'                                                    | 'ВА - ПроцессСумма'                          |
				| ''                     | 'Способ формирования' | 'По правилу обработки'          | 'По правилу обработки'                                                | 'По правилу обработки'                       |
				| ''                     | 'Валюта объекта'      | 'Из регламента: RUB (USD, EUR)' | 'Из регламента: RUB (USD, EUR)'                                       | 'Из регламента: RUB (USD, EUR)'              |
