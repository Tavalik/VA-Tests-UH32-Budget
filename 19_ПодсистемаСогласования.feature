...
Сценарий: 19.01 Создание ролей
	...
	* Отредактировать профиль доступа
		И Я добавляю в профиль 'ВА - Бюджетирование (Редактирование)' роль "Управление процессами и согласованием"		
...
Сценарий: 19.07 Сохранение настроек формы списка экземпляров отчетов	
	...
	* Настраиваем пользователей
		...
		И в таблице "" я выбираю текущую строку
		И Я в списке "Выбор группы пользователей" по полю "Наименование" ищу и выбираю элемент "Бюджетирование" "По точному совпадению"
		Тогда открылось окно "ВА - Согласование - Меркурий ООО (Вариант настройки) *"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
...
Сценарий: 19.09 Согласование по пользователеми
	...
	* Согласование 1 (часть 1)
		...
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\19\ВА_ТестированиеСогласованияЭтап1_Меркурий.mxl" по шаблону
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\19\ВА_ТестированиеСогласованияЭтап2_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование3 (заместитель)
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\19\ВА_ТестированиеСогласованияЭтап4_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование 1 (часть 2)
		...
		Тогда открылось окно 'Согласование'
		И я нажимаю на кнопку с именем 'СогласоватьОтчет'
		Тогда открылось окно 'Экземпляр отчета "ВА - Согласование": <RUB> <Меркурий ООО> <Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>>'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование 2
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\19\ВА_ТестированиеСогласованияЭтап3_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование 4
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\19\ВА_ТестированиеСогласованияАвтоутверждение_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* История согласования
		...
		И табличный документ 'Результат' равен макету "Макеты\19\ВА_ТестированиеСогласованияИстория_Меркурий.mxl" по шаблону			

Сценарий: 19.10 Редактирование ролей

	И я закрываю TestClient "УХ - Бюджетирование"
	И я подключаю TestClient "УХ - Бюджетирование" логин "Администратор" пароль ''

	* Отредактировать профиль доступа
		И Я удаляю из профиля 'ВА - Бюджетирование (Редактирование)' роль "Управление процессами и согласованием"									