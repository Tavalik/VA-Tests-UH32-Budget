...
Сценарий: 11.03 Вводим данные в сводную таблицу	
	...
	* Сложная последовательность отменить / повторить действие
		...
		И в таблице 'РаскрытиеПоказателей' я перехожу к строке:
			...
			| '100'      | '1С:ERP. Управление холдингом' |
...
Сценарий: 11.14 Тестирование формы ввода показателей
	...
	* Открытие формы редактирование, настройки отображения
		...
		И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
		Тогда открылось окно "Раскрытие показателей: *"
		И таблица 'РаскрытиеПоказателей' стала равной:
			| 'ПериодОтчета'    | 'Номенклатура'                                                   | 'Значение1' | 'Значение3' | 'Значение2' | 'Значение4'          | 'Значение5' |
			| 'Февраль 2021 г.' | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '80'        | '320'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '60'        | '240'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Управление холдингом 8'                                      | '100'       | '400'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Корпорация'                                                  | '40'        | '160'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:ERP. Управление холдингом'                                   | '20'        | '80'        | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '120'       | '720'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '90'        | '540'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Управление холдингом 8'                                      | '150'       | '900'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Корпорация'                                                  | '60'        | '360'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:ERP. Управление холдингом'                                   | '30'        | '180'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '40'        | '80'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '30'        | '60'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Управление холдингом 8'                                      | '50'        | '100'       | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Корпорация'                                                  | '20'        | '40'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:ERP. Управление холдингом'                                   | '10'        | '20'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
		...
		И таблица 'РаскрытиеПоказателей' стала равной:
			| 'ПериодОтчета'    | 'Номенклатура'                                                   | 'Значение1' | 'Значение3' | 'Значение2' | 'Значение4'          | 'Значение5' |
			| 'Февраль 2021 г.' | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '0,08000'   | '0,32000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '0,06000'   | '0,24000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Управление холдингом 8'                                      | '0,10000'   | '0,40000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Корпорация'                                                  | '0,04000'   | '0,16000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:ERP. Управление холдингом'                                   | '0,02000'   | '0,08000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '0,12000'   | '0,72000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '0,09000'   | '0,54000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Управление холдингом 8'                                      | '0,15000'   | '0,90000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Корпорация'                                                  | '0,06000'   | '0,36000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:ERP. Управление холдингом'                                   | '0,03000'   | '0,18000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '0,04000'   | '0,08000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '0,03000'   | '0,06000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Управление холдингом 8'                                      | '0,05000'   | '0,10000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Корпорация'                                                  | '0,02000'   | '0,04000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:ERP. Управление холдингом'                                   | '0,01000'   | '0,02000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
	...
	* Режим таблицы по периодам
		...
		Тогда таблица 'РаскрытиеПоказателей' стала равной:
			...
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '720,00000'          | '40,00000'           | 'Строка1'            | '2,00000'            | '80,00000'           | 'Строка1'            | '80,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '320,00000'          | '01.01.2021'         | '120,00000'          | '01.01.2021'         |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '540,00000'          | '30,00000'           | 'Строка1'            | '2,00000'            | '60,00000'           | 'Строка1'            | '60,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '240,00000'          | '01.01.2021'         | '90,00000'           | '01.01.2021'         |
			| '1С:Управление холдингом 8'                                      | '900,00000'          | '50,00000'           | 'Строка1'            | '2,00000'            | '100,00000'          | 'Строка1'            | '100,00000'          | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '400,00000'          | '01.01.2021'         | '150,00000'          | '01.01.2021'         |
			...
			| '1С:ERP. Управление холдингом'                                   | '180,00000'          | '10,00000'           | 'Строка1'            | '2,00000'            | '20,00000'           | 'Строка1'            | '20,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '80,00000'           | '01.01.2021'         | '30,00000'           | '01.01.2021'         |
