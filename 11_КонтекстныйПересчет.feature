...
Сценарий: 11.11 Обратное распределение (пропорциональное)
	...
	* Переходим в режим обратного распределния
		Когда открылось окно "Сводная таблица: ВА - Контекстный пересчет (сводная таблица)( Основной)"
		И я нажимаю на гиперссылку с именем 'ОтборыЗаголовок'
...
Сценарий: 11.13 Изменение показателей в валюте не из регламента
	...
	* Добавлеям значения
		...
		И в табличном документе 'ПолеТабличногоДокументаМакет' я перехожу к ячейке 'R5C2'
		И в табличном документе 'ПолеТабличногоДокументаМакет' я делаю двойной клик на текущей ячейке
		Тогда открылось окно "Раскрытие показателей: Период=Январь * г. \| Организация=Меркурий ООО \| Сценарий=ВА - Основной сценарий \| Статьи движения денежных средств=Реализация программных продуктов \| Валюты=KZT"
