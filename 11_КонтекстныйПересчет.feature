...
Сценарий: 11.05 Тестирование формы ввода показателей
	...
	* Открытие формы редактирование, настройки отображения
		...
		И Таблица 'РаскрытиеПоказателей' содержит '15' строк из списка:
			...
			| 'Февраль 2021 г.' | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '60'        | '240'       | '4'         | '01.01.2021' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '100'       | '400'       | '4'         | '01.01.2021' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Управление холдингом 8'                                      | '20'        | '80'        | '4'         | '01.01.2021' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Корпорация'                                                  | '40'        | '160'       | '4'         | '01.01.2021' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:ERP. Управление холдингом'                                   | '80'        | '320'       | '4'         | '01.01.2021' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '90'        | '540'       | '6'         | '01.01.2021' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '150'       | '900'       | '6'         | '01.01.2021' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Управление холдингом 8'                                      | '30'        | '180'       | '6'         | '01.01.2021' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Корпорация'                                                  | '60'        | '360'       | '6'         | '01.01.2021' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:ERP. Управление холдингом'                                   | '120'       | '720'       | '6'         | '01.01.2021' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '30'        | '60'        | '2'         | '01.01.2021' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '50'        | '100'       | '2'         | '01.01.2021' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Управление холдингом 8'                                      | '10'        | '20'        | '2'         | '01.01.2021' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Корпорация'                                                  | '20'        | '40'        | '2'         | '01.01.2021' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:ERP. Управление холдингом'                                   | '40'        | '80'        | '2'         | '01.01.2021' | 'Строка1'   |
