...
Сценарий: 11.05 Тестирование формы ввода показателей
	...
	* Открытие формы редактирование, настройки отображения
		...
		И Таблица 'РаскрытиеПоказателей' содержит '15' строк из списка:
			...
			| 'Февраль 2021 г.' | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '60'        | '240'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '100'       | '400'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Управление холдингом 8'                                      | '20'        | '80'        | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Корпорация'                                                  | '40'        | '160'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:ERP. Управление холдингом'                                   | '80'        | '320'       | '4'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '90'        | '540'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '150'       | '900'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Управление холдингом 8'                                      | '30'        | '180'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Корпорация'                                                  | '60'        | '360'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:ERP. Управление холдингом'                                   | '120'       | '720'       | '6'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '30'        | '60'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '50'        | '100'       | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Управление холдингом 8'                                      | '10'        | '20'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Корпорация'                                                  | '20'        | '40'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:ERP. Управление холдингом'                                   | '40'        | '80'        | '2'         | '01.01.2021 0:00:00' | 'Строка1'   |
		...
		И Таблица 'РаскрытиеПоказателей' содержит '15' строк из списка:
			| 'ПериодОтчета'    | 'Номенклатура'                                                   | 'Значение1' | 'Значение3' | 'Значение2' | 'Значение4'          | 'Значение5' |
			| 'Февраль 2021 г.' | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '0,06000'   | '0,24000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '0,10000'   | '0,40000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Управление холдингом 8'                                      | '0,02000'   | '0,08000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:Корпорация'                                                  | '0,04000'   | '0,16000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Февраль 2021 г.' | '1С:ERP. Управление холдингом'                                   | '0,08000'   | '0,32000'   | '0,00400'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '0,09000'   | '0,54000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '0,15000'   | '0,90000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Управление холдингом 8'                                      | '0,03000'   | '0,18000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:Корпорация'                                                  | '0,06000'   | '0,36000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Март 2021 г.'    | '1С:ERP. Управление холдингом'                                   | '0,12000'   | '0,72000'   | '0,00600'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '0,03000'   | '0,06000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '0,05000'   | '0,10000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Управление холдингом 8'                                      | '0,01000'   | '0,02000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:Корпорация'                                                  | '0,02000'   | '0,04000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
			| 'Январь 2021 г.'  | '1С:ERP. Управление холдингом'                                   | '0,04000'   | '0,08000'   | '0,00200'   | '01.01.2021 0:00:00' | 'Строка1'   |
...
Сценарий: 11.10 Проверяем сводную таблицу
	...
	* Сравниваем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен по шаблону:
			...
			| 'Товары'                                      | ''                             | '0'              | '0'           | '0'    | ''     | ''       | '0,00054'         | '0,00200'     | '0,00108' | '01.01.2021' | ''        | '0,00161'      | '0,00600'     | '0,00968' | '01.01.2021' | ''        | '0,00215'           | '0,00800'     | '0,01075' | '01.01.2021' | ''        | '0,00215'    | '0,00800'     | '0,01075' | '01.01.2021' | ''       |
			| ''                                            | '1С:ERP. Управление холдингом' | '0'              | '0'           | '0'    | ''     | ''       | '0,00054'         | '0,00200'     | '0,00108' | '01.01.2021' | 'Строка1' | '0,00161'      | '0,00600'     | '0,00968' | '01.01.2021' | 'Строка1' | '0,00215'           | '0,00800'     | '0,01075' | '01.01.2021' | 'Строка1' | '0,00215'    | '0,00800'     | '0,01075' | '01.01.2021' | ''       |
