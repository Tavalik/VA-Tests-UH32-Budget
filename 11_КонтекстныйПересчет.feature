	...
	* Меняем тип показателей
		* Через форму показателя
			* Итог Коэффициент
				...
				Тогда открылось окно 'Итог коэффициент (Показатели отчетов)'
				И я снимаю флаг с именем 'НеФинансовый'
				И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
				И я жду закрытия окна 'Итог коэффициент (Показатели отчетов) *' в течение 20 секунд
			* Итог Дата						
				Когда открылось окно 'Конструктор отчета'
		...
		* Через форму редактирования показателей
			* Товары Коэффициент
				...
				И я изменяю флаг с именем 'НеФинансовыйИзменить'
