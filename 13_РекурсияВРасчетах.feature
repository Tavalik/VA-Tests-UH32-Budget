...
Сценарий: 13.02 Вводим данные в сводную таблицу, получаем ошибку рекурсивного расчета
	...
	* Вводим значение
		...
		ИначеЕсли '$$ЯзыкИнтерфейса$$ = "En"' Тогда
			Тогда табличный документ "ПолеТабличногоДокумента" равен:
				| 'Errors'                                                                                                                                        | '' | ''                                                                                                                       |
				| 'Recursion is found in links when calculating the indicator: "Приемник сумма".\nCheck calculation formulas and rewrite the calculation rule.'   | '' | '{"S","Calculation tree:\n	Итог сумма\n		Накопление сумма\n			Приемник сумма\n				Источник сумма\n				Итог сумма"}'      |
				| 'Recursion is found in links when calculating the indicator: "Накопление сумма".\nCheck calculation formulas and rewrite the calculation rule.' | '' | '{"S","Calculation tree:\n	Приемник сумма\n		Источник сумма\n		Итог сумма\n			Накопление сумма\n				Приемник сумма"}'    |
				| 'Recursion is found in links when calculating the indicator: "Итог сумма".\nCheck calculation formulas and rewrite the calculation rule.'       | '' | '{"S","Calculation tree:\n	Накопление сумма\n		Приемник сумма\n			Источник сумма\n			Итог сумма\n				Накопление сумма"}' |
