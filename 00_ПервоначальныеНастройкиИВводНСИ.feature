...
Сценарий: 00.15 Создание Контрагентов и Договоров контрагентов
	...
	Если '$$ЭтоУХ$$' Тогда
		...
		И Я создаю договор для контрагента "ООО \"Ио\"" номер "Ио-002" дата '01.01.2021' валюта 'RUB' организация "Меркурий ООО" вид "С покупателем" сумма '10000,00' условие оплаты "ВА - Соглашение с клиентом"
