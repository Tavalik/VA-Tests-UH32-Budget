...
Сценарий: 00.19 Установка цен номенклатуры
	...
	Если '$$ЭтоЕРПУХ$$' Тогда	
		...
		* Вводим документ за Январь
			...
			Если в таблице 'ВыбранныеЦены' количество строк "больше" 1 Тогда
			...
			* Запишем документ, проверим движения
				...
				Если '$$ЭтоЕРПУХ$$' Тогда
					Тогда таблица "ОперацииБюджетов" стала равной:
						| 'N' | 'Вид бюджета'                      | 'Приход расход' | 'Сумма' | 'Аналитика партнеров'                                    | 'Курс планирования' | 'Сумма исполнено' | 'Аналитика структуры'                              | 'Количество' | 'Валюта' | 'Курс лимитирования' | 'Аналитика статей бюджетов'               |
