...
Сценарий: 00.05 Настройка ограничений доступа по организациям

	И Я добавляю в группу доступа "Бюджетирование1" значения доступа с видом "Организации" из таблицы
		| "Значение доступа" | "Включая нижестоящие" |
		| "Система ООО"      | "Да"                  |

Сценарий: 00.06 Создание группы Видов отчетов

	И Я создаю группу видов отчетов с именем "ВА - Группа отчетов" и родителем ''

Сценарий: 00.07 Создание Сценария
...
Сценарий: 00.09 Создание Регламента подготовки отчетности
...
Сценарий: 00.10 Создание документа Управление отчетным периодом
...
Сценарий: 00.11 Создание Видов аналитики (корпоративные)
...
Сценарий: 00.12 Создание Вида номенклатуры
...
Сценарий: 00.13 Создание Товарной категории
...
Сценарий: 00.16 Установка цен номенклатуры
...
Сценарий: 00.17 Создание Контрагентов и Договоров контрагентов
...
Сценарий: 00.18 Создание Статей движения денежных средств
...
Сценарий: 00.19 Создание Статьей доходов и расходов
...
Сценарий: 00.20 Создание документа "Отражение фактических данных"
