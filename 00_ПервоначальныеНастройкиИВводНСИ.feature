...
Сценарий: 00.03 Создание профилей и групп доступа
	...
	И Я создаю группу доступа с именем "Бюджетирование1" по профилю "Бюджетирование1"
...
Сценарий: 00.13 Создание документа Управление отчетным периодом
	...
	* Заполняем курсы валют
		...
		* EUR
			...
			И в таблице 'ТаблицаРедактированияКурсов' я перехожу к строке:
				| "Валюта" | "Текущее значение" | "Кратность" | "Период курса"    |
				| 'EUR'    | '92,2963'          | '1,0000'    | "Февраль 2024 г." |
			И в таблице 'ТаблицаРедактированияКурсов' я выбираю текущую строку
			...
			И в таблице 'ТаблицаРедактированияКурсов' я перехожу к строке:
				| "Валюта" | "Текущее значение" | "Кратность" | "Период курса" |
				| 'EUR'    | '90,3743'          | '1,0000'    | "Март 2024 г." |
			И в таблице 'ТаблицаРедактированияКурсов' я выбираю текущую строку
		...
		* USD
			...
			И в таблице 'ТаблицаРедактированияКурсов' я перехожу к строке:
				| "Валюта" | "Текущее значение" | "Кратность" | "Период курса"   |
				| 'USD'    | '73,8757'          | '1,0000'    | "Январь 2024 г." |
			И в таблице 'ТаблицаРедактированияКурсов' я выбираю текущую строку
			...
			И в таблице 'ТаблицаРедактированияКурсов' я перехожу к строке:
				| "Валюта" | "Текущее значение" | "Кратность" | "Период курса"    |
				| 'USD'    | '76,2527'          | '1,0000'    | "Февраль 2024 г." |
			И в таблице 'ТаблицаРедактированияКурсов' я выбираю текущую строку
			...
			И в таблице 'ТаблицаРедактированияКурсов' я перехожу к строке:
				| "Валюта" | "Текущее значение" | "Кратность" | "Период курса" |
				| 'USD'    | '74,4373'          | '1,0000'    | "Март 2024 г." |
			И в таблице 'ТаблицаРедактированияКурсов' я выбираю текущую строку
...
Сценарий: 00.20 Создание Контрагентов и Договоров контрагентов
	...
	Если '$$ЭтоЕРПУХ$$' Тогда
		...
		И Для партнера "ООО \"Ганимед\"" контрагента "ООО \"Ганимед\"" я создаю договор с видом "С покупателем" номер "Ганимед-002" от '01.01.2024' организация "Меркурий ООО" валюта 'RUB' сумма '10000,00' соглашение "ВА - Соглашение с клиентом" в 1C:ERPУХ		
		...
		И Для партнера "ООО \"Ио\"" контрагента "ООО \"Ио\"" я создаю договор с видом "С покупателем" номер "Ио-002" от '01.01.2024' организация "Меркурий ООО" валюта 'RUB' сумма '10000,00' соглашение "ВА - Соглашение с клиентом" в 1C:ERPУХ		
		И Для партнера "ООО \"Ио\"" контрагента "ООО \"Ио\"" я создаю договор с видом "С покупателем" номер 'Ио-002' от '01.01.2024' организация "Меркурий ООО" валюта 'RUB' сумма '10000,00' соглашение "ВА - Соглашение с клиентом" в 1C:ERPУХ		
