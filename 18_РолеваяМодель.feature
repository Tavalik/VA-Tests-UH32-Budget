...
Сценарий: 18.23 Проверка формы настроек экземпляров отчетов для "Бюджетирование1"
	...
	* Проверяем форму настроек
		...
		И Я закрываю окно "Январь * г. - Март * г. (Периодичность: Месяц) <ВА - Основной сценарий>"
		Тогда открылось окно "Настройки документа"
		...
		Тогда открылось окно "Настройки документа"
		И я нажимаю на кнопку открытия поля с именем 'ИспользуемаяИБ'
