...
Сценарий: 18.13 Проверка формы настроек экземпляров отчетов для "Бюджетирование1"
	...
	* Меняем период
		...
		Тогда элемент формы с именем 'Периодичность' стал равен "Месяц"
		Тогда элемент формы с именем 'ПериодОтчета' стал равен ""	
		Тогда элемент формы с именем 'ПериодОкончания' стал равен ""	
		Тогда элемент формы с именем 'Регламент' стал равен ""	
	...
	* Закрываем формы
		...
		И Я закрываю окно "Экземпляр отчета *"
...
Сценарий: 18.34 Тест интерфейса для пользователя "Бюджетирование1" - Отчеты
...
Сценарий: 18.35 Тест интерфейса для пользователя "Бюджетирование1" - Сервис
