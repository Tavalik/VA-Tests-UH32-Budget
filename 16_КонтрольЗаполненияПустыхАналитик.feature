...
Сценарий: 16.04 Создание экземпляра отчета "ВА - Пустые аналитики"
	...
	Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
		...
		| "Источник"                      | '200'            | '01.01.2024' | '400'             | '02.02.2024' | '0'            | ''     | '600'   | ''     |
		| "1С:ERP. Управление холдингом " | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "Программные продукты "         | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "1С:Управление холдингом 8 "    | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "Программные продукты "         | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "Приемник1"                     | '200'            | '01.01.2024' | '400'             | '02.02.2024' | '0'            | ''     | '600'   | ''     |
		| "1С:ERP. Управление холдингом " | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| ' '                             | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "1С:Управление холдингом 8 "    | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| ' '                             | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "Приемник2"                     | '200'            | '01.01.2024' | '400'             | '02.02.2024' | '0'            | ''     | '600'   | ''     |
		| "1С:ERP. Управление холдингом " | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| ' '                             | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| "1С:Управление холдингом 8 "    | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
		| ' '                             | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
...
Сценарий: 16.05 Создание сводной таблицы "ВА - Пустые аналитики"		
	...
	* Сверяем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "Источник"                                | '200'            | '01.01.2024' | '400'             | '02.02.2024' | '0'            | ''     | '600'   | ''     |
			| "Внедрение программных продуктов"         | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
			| "1С:ERP. Управление холдингом"            | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
			| "Программные продукты"                    | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
			| "Реализация программных продуктов"        | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
			| "1С:Управление холдингом 8"               | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
			| "Программные продукты"                    | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
			| "Приемник1"                               | '200'            | '01.01.2024' | '400'             | '02.02.2024' | '0'            | ''     | '600'   | ''     |
			| "Внедрение программных продуктов"         | '100'            | '01.01.2024' | '200'             | '02.02.2024' | '0'            | ''     | '300'   | ''     |
