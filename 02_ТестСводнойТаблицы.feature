...
Функционал: 11. Проверка работы сводной таблицы
...
Сценарий: 11.05 Тестирование формы ввода показателей
	...
	* Открытие формы редактирование, настройки отображения
		...
		И Таблица 'РаскрытиеПоказателей' содержит '5' строк из списка:
			| 'Номенклатура'                                                   | 'Период_3_Значение3' | 'Период_1_Значение1' | 'Период_3_Значение5' | 'Период_1_Значение2' | 'Период_2_Значение1' | 'Период_2_Значение5' | 'Период_1_Значение3' | 'Период_1_Значение4' | 'Период_1_Значение5' | 'Период_3_Значение2' | 'Период_2_Значение2' | 'Период_2_Значение3' | 'Период_2_Значение4' | 'Период_3_Значение1' | 'Период_3_Значение4' |
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '540,00000'          | '30,00000'           | 'Строка1'            | '2,00000'            | '60,00000'           | 'Строка1'            | '60,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '240,00000'          | '01.01.2021'         | '90,00000'           | '01.01.2021'         |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '900,00000'          | '50,00000'           | 'Строка1'            | '2,00000'            | '100,00000'          | 'Строка1'            | '100,00000'          | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '400,00000'          | '01.01.2021'         | '150,00000'          | '01.01.2021'         |
			| '1С:Управление холдингом 8'                                      | '180,00000'          | '10,00000'           | 'Строка1'            | '2,00000'            | '20,00000'           | 'Строка1'            | '20,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '80,00000'           | '01.01.2021'         | '30,00000'           | '01.01.2021'         |
			| '1С:Корпорация'                                                  | '360,00000'          | '20,00000'           | 'Строка1'            | '2,00000'            | '40,00000'           | 'Строка1'            | '40,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '160,00000'          | '01.01.2021'         | '60,00000'           | '01.01.2021'         |
			| '1С:ERP. Управление холдингом'                                   | '720,00000'          | '40,00000'           | 'Строка1'            | '2,00000'            | '80,00000'           | 'Строка1'            | '80,00000'           | '01.01.2021'         | 'Строка1'            | '6,00000'            | '4,00000'            | '320,00000'          | '01.01.2021'         | '120,00000'          | '01.01.2021'         |
