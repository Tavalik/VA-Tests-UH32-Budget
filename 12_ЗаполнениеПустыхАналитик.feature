...
Сценарий: 12.03 Создаем экземпляр отчета без записи и заполнения аналитик
	...
	* Сравниваем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "Источник"                        | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| ' '                               | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| ' '                               | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| "ПремникТаЖеАналитика"            | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| ' '                               | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| ' '                               | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| "ПремникПустаяАналитика"          | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| ' '                               | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
			| ' '                               | '1 000'          | ''     | '0'               | '01.02.2024' | '0'            | ''     | '1 000' | ''     |
...
Сценарий: 12.04 Создаем экземпляр отчета без записи с заполнением аналитик
	...
	* Сравниваем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| ''                                | "Январь 2024 г." | ''           | "Февраль 2024 г." | ''           | "Март 2024 г." | ''           | "ИТОГО" | ''     |
			| ''                                | "Сумма"          | "Дата"       | "Сумма"           | "Дата"       | "Сумма"        | "Дата"       | "Сумма" | "Дата" |
			| "Источник"                        | '100'            | '01.01.2024' | '200'             | '01.02.2024' | '300'          | '01.03.2024' | '600'   | ''     |
			| "Программные продукты "           | '100'            | '01.01.2024' | '200'             | '01.02.2024' | '300'          | '01.03.2024' | '600'   | ''     |
			| ' '                               | '100'            | '01.01.2024' | '0'               | ''           | '0'            | ''           | '100'   | ''     |
			| "1С:Управление холдингом 8 "      | '0'              | ''           | '200'             | '01.02.2024' | '0'            | ''           | '200'   | ''     |
			| "1С:ERP. Управление холдингом "   | '0'              | ''           | '0'               | ''           | '300'          | '01.03.2024' | '300'   | ''     |
			| "ПремникТаЖеАналитика"            | '100'            | '01.01.2024' | '200'             | '01.02.2024' | '300'          | '01.03.2024' | '600'   | ''     |
			| "Программные продукты "           | '100'            | '01.01.2024' | '200'             | '01.02.2024' | '300'          | '01.03.2024' | '600'   | ''     |
			| ' '                               | '100'            | '01.01.2024' | '0'               | ''           | '0'            | ''           | '100'   | ''     |
			| "1С:Управление холдингом 8 "      | '0'              | ''           | '200'             | '01.02.2024' | '0'            | ''           | '200'   | ''     |
			| "1С:ERP. Управление холдингом "   | '0'              | ''           | '0'               | ''           | '300'          | '01.03.2024' | '300'   | ''     |
			| "ПремникПустаяАналитика"          | '100'            | '01.01.2024' | '200'             | '01.02.2024' | '300'          | '01.03.2024' | '600'   | ''     |
			| "Программные продукты "           | '100'            | '01.01.2024' | '200'             | '01.02.2024' | '300'          | '01.03.2024' | '600'   | ''     |
			| ' '                               | '100'            | '01.01.2024' | '0'               | ''           | '0'            | ''           | '100'   | ''     |
			| "1С:Управление холдингом 8 "      | '0'              | ''           | '200'             | '01.02.2024' | '0'            | ''           | '200'   | ''     |
			| "1С:ERP. Управление холдингом "   | '0'              | ''           | '0'               | ''           | '300'          | '01.03.2024' | '300'   | ''     |
