...
Сценарий: 12.02 Создаем вид отчета и структуру отчета
	...
	* Устанавливаем формулы
	...
	И Я Для вида отчета 'ВА - Заполнение пустых аналитик' в бланке для группы раскрытия с адресом 'R9C1' задаю сортировку 'Номенклатура.Артикул'
	И Я Для вида отчета 'ВА - Заполнение пустых аналитик' в бланке для группы раскрытия с адресом 'R12C1' задаю сортировку 'Номенклатура.Артикул'
	И Я Для вида отчета 'ВА - Заполнение пустых аналитик' в бланке для группы раскрытия с адресом 'R15C1' задаю сортировку 'Номенклатура.Артикул'
