...
Сценарий: 17.04 Создание внешней информационной базы "ВА - ПроцессИмпортЦена"
	...
	И Я создаю внешнюю информационную базу "ВА - ПроцессИмпортЦена" тип "Файлы Microsoft Excel" каталог "$КаталогПроекта$\Макеты\17" тип хранилища ''
	...
	* Тестируем механизм маски имени
		...
		Тогда элемент формы с именем 'МаскаПолногоИмени' стал равен "$КаталогПроекта$\Макеты\17\<Вид отчета>+<Организация>.xls?"
...
Сценарий: 17.10 Ход выполнения процесса подготовки отчетности

	И В командном интерфейсе я выбираю "Процессы и согласование" "Диаграмма управления процессом"
	Когда открылось окно "Ход выполнения процесса подготовки отчетности"
	// ДОДЕЛАТЬ ТЕСТ

Сценарий: 17.11 Ручное заполнение - "ВА - ПроцессКоличество"
...
Сценарий: 17.12 Импорт - "ВА - ПроцессЦена"	
...
Сценарий: 17.13 Консолидация - "ВА - ПроцессСумма"
...
Сценарий: 17.14 Останавливаем процесс
