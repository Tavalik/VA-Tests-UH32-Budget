...
Сценарий: 01.08 Создание экземпляра отчета
	...
	* Вводим значения в таблицу
		...
		И Я добавляю значения с раскрытием показателей в ячейку 'R17C2'
			| 'ВА0ТовКате'           | 'ВА0Номенкл'                | 'ВА0Контраг'      | 'ВА0ДогКонт'  | 'Значение'    |
		...
		И Я добавляю значения с раскрытием показателей в ячейку 'R22C2'
			| 'ВА0ТовКате'           | 'ВА0Номенкл'                | 'ВА0Контраг'      | 'ВА0ДогКонт'  | 'ВА0СтатДДС'                       | 'Значение'    |
		...
		И Я добавляю значения с раскрытием показателей в ячейку 'R28C2'
			| 'ВА0ТовКате'           | 'ВА0Номенкл'                | 'ВА0Контраг'      | 'ВА0ДогКонт'  | 'ВА0СтатДДС'                       | 'ВА0СДохРас'                       | 'Значение'    |
		...
		И Я добавляю значения с раскрытием показателей в ячейку 'R35C2'
			| 'ВА0ТовКате'           | 'ВА0Номенкл'                | 'ВА0Контраг'      | 'ВА0ДогКонт'  | 'ВА0СтатДДС'                       | 'ВА0СДохРас'                       | 'АналитикаВалюта' | 'Значение'    |
...
Сценарий: 01.09 Проверяем движения документа
	...
	* Проверяем движения документа
		...
		// ДОДЕЛАТЬ, Временная заглушка для CPMWE, пока не переведены табличные документы
		Если '$$ЯзыкИнтерфейса$$ = "Ru"' Тогда
...
Сценарий: 01.10 Копирование экземпляра отчета
	...
	* Копирование экземпляра
		...
		Тогда Открылся экземпляр отчета для вида отчета 'ВА - Ручной ввод по всем аналитикам' валюта 'RUB' организация 'Меркурий ООО' сценарий 'ВА - Основной сценарий' периодичность "Месяц" проект 'ВА - Основной проект' аналитики '' '' '' '' '' ''
