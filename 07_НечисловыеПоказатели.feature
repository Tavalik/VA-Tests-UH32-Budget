...
Сценарий: 07.10 Расчет с удалением показателей
	...
	* Проверяем форму
		...
		И элемент формы с именем 'БланкИмпорта' стал равен "ВА - Нечисловые показатели (приемник)"
		...
		И элемент формы с именем 'ДополнительныеВалюты' стал равен "EUR; USD"
		...
		И элемент формы с именем 'ИспользуемаяИБ' стал равен "Текущая информационная база"
