...
Сценарий: 07.03 Создание экземпляра отчета - 'ВА - Нечисловые показатели (источник)' 
	...
	* Документ должен быть пустой
		// ДОДЕЛАТЬ: Новый формат для булево еще не приехал в Перформ
	...
	* Сравниваем итоговый документ
		...
		Если '$$ЯзыкИнтерфейса$$ <> "Ru"' Тогда
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен по шаблону:
				...
				| ''                                                                | 'Январь 2021 г.' | ''                | ''               | ''        | 'Февраль 2021 г.' | ''                | ''               | ''        | 'Март 2021 г.' | ''                | ''               | ''        | 'ИТОГО' | ''                | ''               | ''        |
				| ''                                                                | 'Цена'           | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'            | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'         | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'  | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' |
				| 'Товары'                                                          | '1 206 000'      | '*'               | ''               | ''        | '1 326 600'       | '*'               | ''               | ''        | '1 326 600'    | '*'               | ''               | ''        | '0'     | '*'               | ''               | ''        |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'               | "Да"             | '000001'  | '2 145 000'       | '*'               | "Да"             | '2000001' | '2 145 000'    | '*'               | "Да"             | '2000001' | '0'     | '*'               | ''               | ''        |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'               | "Да"             | '000002'  | '2 255 000'       | ''                | ''               | ''        | '2 255 000'    | ''                | ''               | ''        | '0'     | '*'               | ''               | ''        |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'               | "Да"             | '000003'  | '198 000'         | ''                | ''               | ''        | '198 000'      | ''                | ''               | ''        | '0'     | '*'               | ''               | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'               | "Да"             | '000004'  | '660 000'         | ''                | ''               | ''        | '660 000'      | ''                | ''               | ''        | '0'     | '*'               | ''               | ''        |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'               | "Да"             | '000005'  | '1 375 000'       | '*'               | "Да"             | '2000005' | '1 375 000'    | '*'               | "Да"             | '2000005' | '0'     | '*'               | ''               | ''        |
		Иначе
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
				| 'ВА - Нечисловые показатели (источник)'                           | ''               | ''                | ''               | ''        | ''                | ''                | ''               | ''        | ''             | ''                | ''               | ''        | ''      | ''                | ''               | ''        |
				| ''                                                                | ''               | ''                | ''               | ''        | ''                | ''                | ''               | ''        | ''             | ''                | ''               | ''        | ''      | ''                | ''               | ''        |
				...
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '01.01.2021'      | "Да"             | '000001'  | '2 145 000'       | '02.01.2021'      | "Да"             | '2000001' | '2 145 000'    | '02.01.2021'      | "Да"             | '2000001' | '0'     | '01.01.2021'      | "Нет"            | ''        |
				| '1С:Корпорация '                                                  | '2 050 000'      | '01.02.2021'      | "Да"             | '000002'  | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '0'     | '01.02.2021'      | "Нет"            | ''        |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '01.03.2021'      | "Да"             | '000003'  | '198 000'         | ''                | "Нет"            | ''        | '198 000'      | ''                | "Нет"            | ''        | '0'     | '01.03.2021'      | "Нет"            | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '01.04.2021'      | "Да"             | '000004'  | '660 000'         | ''                | "Нет"            | ''        | '660 000'      | ''                | "Нет"            | ''        | '0'     | '01.04.2021'      | "Нет"            | ''        |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '01.05.2021'      | "Да"             | '000005'  | '1 375 000'       | '02.05.2021'      | "Да"             | '2000005' | '1 375 000'    | '02.05.2021'      | "Да"             | '2000005' | '0'     | '01.05.2021'      | "Нет"            | ''        |
	...
	* Рассчитываем документ и сравниваем итоговый документ
		...
		Если '$$ЯзыкИнтерфейса$$ <> "Ru"' Тогда
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен по шаблону:
				...
				| ''                                                                | 'Январь 2021 г.' | ''                | ''               | ''              | 'Февраль 2021 г.' | ''                | ''               | ''              | 'Март 2021 г.' | ''                | ''               | ''              | 'ИТОГО'      | ''                | ''               | ''        |
				| ''                                                                | 'Цена'           | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул'       | 'Цена'            | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул'       | 'Цена'         | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул'       | 'Цена'       | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' |
				| 'Товары'                                                          | '6 030 000'      | '*'               | "Да"             | ''              | '6 633 000'       | '*'               | "Да"             | ''              | '6 633 000'    | '*'               | "Да"             | ''              | '19 296 000' | '*'               | "Да"             | ''        |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'               | "Да"             | '000001'        | '2 145 000'       | '*'               | "Да"             | '2000001'       | '2 145 000'    | '*'               | "Да"             | '2000001'       | '6 240 000'  | '*'               | "Да"             | ''        |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'               | "Да"             | '000002'        | '2 255 000'       | ''                | ''               | ''              | '2 255 000'    | ''                | ''               | ''              | '6 560 000'  | '*'               | "Да"             | ''        |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'               | "Да"             | '000003'        | '198 000'         | ''                | ''               | ''              | '198 000'      | ''                | ''               | ''              | '996 000'    | '*'               | "Да"             | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'               | "Да"             | '000004'        | '660 000'         | ''                | ''               | ''              | '660 000'      | ''                | ''               | ''              | '1 500 000'  | '*'               | "Да"             | ''        |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'               | "Да"             | '000005'        | '1 375 000'       | '*'               | "Да"             | '2000005'       | '1 375 000'    | '*'               | "Да"             | '2000005'       | '4 000 000'  | '*'               | "Да"             | ''        |
				| 'Формулы'                                                         | '6 030 000'      | '*'               | ''               | ''              | '3 519 997'       | '*'               | "Да"             | ''              | '3 519 997'    | '*'               | ''               | ''              | '13 069 994' | '*'               | "Да"             | ''        |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'               | ''               | '100000'        | '2 145 000'       | '*'               | ''               | '1000002'       | '2 145 000'    | '*'               | ''               | '1000002'       | '6 240 000'  | '*'               | ''               | ''        |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'               | ''               | '200000'        | '-1'              | ''                | "Да"             | ''              | '-1'           | ''                | ''               | ''              | '2 049 998'  | '*'               | "Да"             | ''        |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'               | ''               | '300000'        | '-1'              | ''                | ''               | ''              | '-1'           | ''                | ''               | ''              | '599 998'    | '*'               | ''               | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'               | ''               | '400000'        | '-1'              | ''                | ''               | ''              | '-1'           | ''                | ''               | ''              | '179 998'    | '*'               | ''               | ''        |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'               | ''               | '500000'        | '1 375 000'       | '*'               | ''               | '5000002'       | '1 375 000'    | '*'               | ''               | '5000002'       | '4 000 000'  | '*'               | ''               | ''        |
				| 'Источник'                                                        | '6 030 000'      | '*'               | "Да"             | ''              | '6 633 000'       | '*'               | "Да"             | ''              | '7 495 400'    | '*'               | "Да"             | ''              | '20 158 400' | '*'               | "Да"             | ''        |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'               | "Да"             | '2900001970198' | '2 145 000'       | '*'               | "Да"             | '2900001970198' | '2 423 900'    | '*'               | "Да"             | '2900001970198' | '6 518 900'  | '*'               | "Да"             | ''        |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'               | ''               | '2900001871419' | '2 255 000'       | '*'               | ''               | '2900001871419' | '2 548 200'    | '*'               | ''               | '2900001871419' | '6 853 200'  | '*'               | ''               | ''        |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'               | ''               | '4601546106674' | '660 000'         | '*'               | ''               | '4601546106674' | '745 800'      | '*'               | ''               | '4601546106674' | '2 005 800'  | '*'               | ''               | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'               | ''               | '2900001916059' | '198 000'         | '*'               | ''               | '2900001916059' | '223 700'      | '*'               | ''               | '2900001916059' | '601 700'    | '*'               | ''               | ''        |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'               | "Да"             | '2900001871389' | '1 375 000'       | '*'               | "Да"             | '2900001871389' | '1 553 800'    | '*'               | "Да"             | '2900001871389' | '4 178 800'  | '*'               | "Да"             | ''        |
		Иначе
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
				| 'ВА - Нечисловые показатели (приемник)'                           | ''               | ''                | ''               | ''              | ''                | ''                | ''               | ''              | ''             | ''                | ''               | ''              | ''           | ''                | ''               | ''        |
				| ''                                                                | ''               | ''                | ''               | ''              | ''                | ''                | ''               | ''              | ''             | ''                | ''               | ''              | ''           | ''                | ''               | ''        |
				...
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '01.03.2021'      | "Да"             | '000003'        | '198 000'         | ''                | "Нет"            | ''              | '198 000'      | ''                | "Нет"            | ''              | '996 000'    | '01.03.2021'      | "Да"             | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '01.04.2021'      | "Да"             | '000004'        | '660 000'         | ''                | "Нет"            | ''              | '660 000'      | ''                | "Нет"            | ''              | '1 500 000'  | '01.04.2021'      | "Да"             | ''        |
				...
				| 'Формулы'                                                         | '6 030 000'      | '02.05.2021'      | "Нет"            | ''              | '3 519 997'       | '03.05.2021'      | "Да"             | ''              | '3 519 997'    | '03.05.2021'      | "Нет"            | ''              | '13 069 994' | '03.05.2021'      | "Да"             | ''        |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '02.01.2021'      | "Нет"            | '100000'        | '2 145 000'       | '03.01.2021'      | "Нет"            | '1000002'       | '2 145 000'    | '03.01.2021'      | "Нет"            | '1000002'       | '6 240 000'  | '03.01.2021'      | "Нет"            | ''        |
				| '1С:Корпорация '                                                  | '2 050 000'      | '02.02.2021'      | "Нет"            | '200000'        | '-1'              | ''                | "Да"             | ''              | '-1'           | ''                | "Нет"            | ''              | '2 049 998'  | '02.02.2021'      | "Да"             | ''        |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '02.03.2021'      | "Нет"            | '300000'        | '-1'              | ''                | "Нет"            | ''              | '-1'           | ''                | "Нет"            | ''              | '599 998'    | '02.03.2021'      | "Нет"            | ''        |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '02.04.2021'      | "Нет"            | '400000'        | '-1'              | ''                | "Нет"            | ''              | '-1'           | ''                | "Нет"            | ''              | '179 998'    | '02.04.2021'      | "Нет"            | ''        |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '02.05.2021'      | "Нет"            | '500000'        | '1 375 000'       | '03.05.2021'      | "Нет"            | '5000002'       | '1 375 000'    | '03.05.2021'      | "Нет"            | '5000002'       | '4 000 000'  | '03.05.2021'      | "Нет"            | ''        |
	...
	* Рассчитываем документ и сверяем результат
		...
		Если '$$ЯзыкИнтерфейса$$ <> "Ru"' Тогда
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен по шаблону:
				...
				| 'Источник'                                                        | '6 030 000'      | '*'    | "Да"     | ''                                                             | '6 633 000'       | '*'    | "Да"     | ''                                                              | '6 633 000'    | '*'    | "Да"     | ''                                                           | '19 296 000' | '*'    | "Да"     | ''       |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'    | "Да"     | '000001'                                                       | '2 145 000'       | '*'    | "Да"     | '2000001'                                                       | '2 145 000'    | '*'    | "Да"     | '2000001'                                                    | '6 240 000'  | '*'    | "Да"     | ''       |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'    | "Да"     | '000002'                                                       | '2 255 000'       | ''     | ''       | ''                                                              | '2 255 000'    | ''     | ''       | ''                                                           | '6 560 000'  | '*'    | "Да"     | ''       |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'    | "Да"     | '000003'                                                       | '198 000'         | ''     | ''       | ''                                                              | '198 000'      | ''     | ''       | ''                                                           | '996 000'    | '*'    | "Да"     | ''       |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'    | "Да"     | '000004'                                                       | '660 000'         | ''     | ''       | ''                                                              | '660 000'      | ''     | ''       | ''                                                           | '1 500 000'  | '*'    | "Да"     | ''       |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'    | "Да"     | '000005'                                                       | '1 375 000'       | '*'    | "Да"     | '2000005'                                                       | '1 375 000'    | '*'    | "Да"     | '2000005'                                                    | '4 000 000'  | '*'    | "Да"     | ''       |
				| 'ИсточникКод'                                                     | '6 030 000'      | '*'    | "Да"     | '000005'                                                       | '6 633 000'       | '*'    | "Да"     | '2000005'                                                       | '6 633 000'    | '*'    | "Да"     | '2000005'                                                    | '19 296 000' | '*'    | "Да"     | ''       |
				| 'ПриемникКод'                                                     | '0'              | ''     | ''       | ''                                                             | '0'               | ''     | ''       | ''                                                              | '0'            | ''     | ''       | ''                                                           | '0'          | ''     | ''       | ''       |
				| 'ФормулыКод'                                                      | '1'              | '*'    | "Да"     | 'Меркурий ООО\nВА - Основной сценарий\nRUB\nЯнварь 2021 г.\n*' | '2'               | '*'    | ''       | 'Меркурий ООО\nВА - Основной сценарий\nRUB\nФевраль 2021 г.\n*' | '3'            | '*'    | ''       | 'Меркурий ООО\nВА - Основной сценарий\nRUB\nМарт 2021 г.\n*' | '6'          | '*'    | "Да"     | ''       |
				| 'Расчет'                                                          | '6 030 000'      | '*'    | ''       | ''                                                             | '13 266 000'      | '*'    | "Да"     | ''                                                              | '19 899 000'   | '*'    | ''       | ''                                                           | '39 195 000' | '*'    | "Да"     | ''       |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'    | ''       | '!!! 000001'                                                   | '4 290 000'       | '*'    | ''       | '!!! 2000001'                                                   | '6 435 000'    | '*'    | ''       | '!!! 2000001'                                                | '12 675 000' | '*'    | ''       | ''       |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'    | ''       | '!!! 000002'                                                   | '4 510 000'       | ''     | "Да"     | ''                                                              | '6 765 000'    | ''     | ''       | ''                                                           | '13 325 000' | '*'    | "Да"     | ''       |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'    | ''       | '!!! 000003'                                                   | '396 000'         | ''     | ''       | ''                                                              | '594 000'      | ''     | ''       | ''                                                           | '1 590 000'  | '*'    | ''       | ''       |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'    | ''       | '!!! 000004'                                                   | '1 320 000'       | ''     | ''       | ''                                                              | '1 980 000'    | ''     | ''       | ''                                                           | '3 480 000'  | '*'    | ''       | ''       |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'    | ''       | '!!! 000005'                                                   | '2 750 000'       | '*'    | ''       | '!!! 2000005'                                                   | '4 125 000'    | '*'    | ''       | '!!! 2000005'                                                | '8 125 000'  | '*'    | ''       | ''       |
		Иначе
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
				| 'ВА - Расчет в коде'                                              | ''               | ''           | ''       | ''                                                                 | ''                | ''           | ''       | ''                                                                  | ''             | ''           | ''       | ''                                                               | ''           | ''           | ''       | ''       |
				| ''                                                                | ''               | ''           | ''       | ''                                                                 | ''                | ''           | ''       | ''                                                                  | ''             | ''           | ''       | ''                                                               | ''           | ''           | ''       | ''       |
				...
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '01.02.2021' | "Нет"    | '!!! 000001'                                                       | '4 290 000'       | '02.02.2021' | "Нет"    | '!!! 2000001'                                                       | '6 435 000'    | '02.02.2021' | "Нет"    | '!!! 2000001'                                                    | '12 675 000' | '02.02.2021' | "Нет"    | ''       |
				| '1С:Корпорация '                                                  | '2 050 000'      | '01.03.2021' | "Нет"    | '!!! 000002'                                                       | '4 510 000'       | ''           | "Да"     | ''                                                                  | '6 765 000'    | ''           | "Нет"    | ''                                                               | '13 325 000' | '01.03.2021' | "Да"     | ''       |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '01.04.2021' | "Нет"    | '!!! 000003'                                                       | '396 000'         | ''           | "Нет"    | ''                                                                  | '594 000'      | ''           | "Нет"    | ''                                                               | '1 590 000'  | '01.04.2021' | "Нет"    | ''       |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '01.05.2021' | "Нет"    | '!!! 000004'                                                       | '1 320 000'       | ''           | "Нет"    | ''                                                                  | '1 980 000'    | ''           | "Нет"    | ''                                                               | '3 480 000'  | '01.05.2021' | "Нет"    | ''       |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '01.06.2021' | "Нет"    | '!!! 000005'                                                       | '2 750 000'       | '02.06.2021' | "Нет"    | '!!! 2000005'                                                       | '4 125 000'    | '02.06.2021' | "Нет"    | '!!! 2000005'                                                    | '8 125 000'  | '02.06.2021' | "Нет"    | ''       |
	...
	* Рассчитываем документ еще раз и сверяем изменившийся результат
		...
		Если '$$ЯзыкИнтерфейса$$ <> "Ru"' Тогда
			Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен по шаблону:
				...
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'    | "Да"     | '000005'                                                       | '1 375 000'       | '*'    | "Да"     | '2000005'                                                       | '1 375 000'    | '*'    | "Да"     | '2000005'                                                    | '4 000 000'  | '*'    | "Да"     | ''       |
				| 'ИсточникКод'                                                     | '6 030 000'      | '*'    | "Да"     | '000005'                                                       | '6 633 000'       | '*'    | "Да"     | '2000005'                                                       | '6 633 000'    | '*'    | "Да"     | '2000005'                                                    | '19 296 000' | '*'    | "Да"     | ''       |
				| 'ПриемникКод'                                                     | '6 030 000'      | '*'    | "Да"     | '000005'                                                       | '6 633 000'       | '*'    | "Да"     | '2000005'                                                       | '6 633 000'    | '*'    | "Да"     | '2000005'                                                    | '19 296 000' | '*'    | "Да"     | ''       |
				| 'ФормулыКод'                                                      | '1'              | '*'    | "Да"     | 'Меркурий ООО\nВА - Основной сценарий\nRUB\nЯнварь 2021 г.\n*' | '2'               | '*'    | ''       | 'Меркурий ООО\nВА - Основной сценарий\nRUB\nФевраль 2021 г.\n*' | '3'            | '*'    | ''       | 'Меркурий ООО\nВА - Основной сценарий\nRUB\nМарт 2021 г.\n*' | '6'          | '*'    | "Да"     | ''       |
				| 'Расчет'                                                          | '6 030 000'      | '*'    | ''       | ''                                                             | '13 266 000'      | '*'    | "Да"     | ''                                                              | '19 899 000'   | '*'    | ''       | ''                                                           | '39 195 000' | '*'    | "Да"     | ''       |
				| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '*'    | ''       | '!!! 000001'                                                   | '4 290 000'       | '*'    | ''       | '!!! 2000001'                                                   | '6 435 000'    | '*'    | ''       | '!!! 2000001'                                                | '12 675 000' | '0*'   | ''       | ''       |
				| '1С:Корпорация '                                                  | '2 050 000'      | '*'    | ''       | '!!! 000002'                                                   | '4 510 000'       | ''     | "Да"     | ''                                                              | '6 765 000'    | ''     | ''       | ''                                                           | '13 325 000' | '*'    | "Да"     | ''       |
				| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '*'    | ''       | '!!! 000003'                                                   | '396 000'         | ''     | ''       | ''                                                              | '594 000'      | ''     | ''       | ''                                                           | '1 590 000'  | '*'    | ''       | ''       |
				| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '*'    | ''       | '!!! 000004'                                                   | '1 320 000'       | ''     | ''       | ''                                                              | '1 980 000'    | ''     | ''       | ''                                                           | '3 480 000'  | '*'    | ''       | ''       |
				| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '*'    | ''       | '!!! 000005'                                                   | '2 750 000'       | '*'    | ''       | '!!! 2000005'                                                   | '4 125 000'    | '*'    | ''       | '!!! 2000005'                                                | '8 125 000'  | '*'    | ''       | ''       |
