...
Сценарий: 07.02 Создание вида отчета "ВА - Нечисловые показатели (источник)"
	...
	И я в конструкторе отчета в ячейке 'R2C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
	...
	И я в конструкторе отчета в ячейке 'R2C4' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"		
	И я в конструкторе отчета в ячейке 'R2C4' меняю свойство показателя 'ВидИтога' на "Итог по группе раскрытия не рассчитывается"
	И я в конструкторе отчета в ячейке 'R2C5' меняю свойство показателя 'ТипЗначения' на "Строка"
	И я в конструкторе отчета в ячейке 'R2C5' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
...
Сценарий: 07.04 Интерактивное удаление показателей
	...
	И Я создаю экземпляр отчета для вида отчета "ВА - Нечисловые показатели (источник)" сценарий "ВА - Основной сценарий" период '01.01.2021' '31.03.2021' периодичность "Месяц" организация "Венера ООО" проект "ВА - Основной проект" аналитики "Реализация программных продуктов" '' '' '' '' '' 
	...
	* Вводим значения показателей
		И Я добавляю значения с раскрытием показателей в ячейку 'R6C1'
			...
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | 'Нет'                | '180 000,00000'      | '01.03.2021'         | '198 000,00000'      | 'Да'                 | '000003'             | ''                   | 'Нет'                | ''                   | '198 000,00000'      | ''                   | ''                   |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | 'Нет'                | '600 000,00000'      | '01.05.2021'         | '1 375 000,00000'    | 'Да'                 | '000005'             | ''                   | 'Нет'                | ''                   | '1 375 000,00000'    | ''                   | ''                   |
			| '1С:Управление холдингом 8'                                      | 'Да'                 | '1 250 000,00000'    | '01.01.2021'         | '2 145 000,00000'    | 'Да'                 | '000001'             | '02.05.2021'         | 'Да'                 | '2000005'            | '2 145 000,00000'    | '02.05.2021'         | '2000005'            |
			| '1С:Корпорация'                                                  | 'Нет'                | '2 050 000,00000'    | '01.02.2021'         | '2 255 000,00000'    | 'Да'                 | '000002'             | ''                   | 'Нет'                | ''                   | '2 255 000,00000'    | ''                   | ''                   |
			| '1С:ERP. Управление холдингом'                                   | 'Да'                 | '1 950 000,00000'    | '01.04.2021'         | '660 000,00000'      | 'Да'                 | '000004'             | '02.01.2021'         | 'Да'                 | '2000001'            | '660 000,00000'      | '02.01.2021'         | '2000001'            |
	...
	* Сверяем результат
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| ''                                                                | 'Январь 2021 г.' | ''                | ''               | ''        | 'Февраль 2021 г.' | ''                | ''               | ''        | 'Март 2021 г.' | ''                | ''               | ''        | 'ИТОГО' | ''                | ''               | ''        |
			| ''                                                                | 'Цена'           | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'            | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'         | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'  | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' |
			| 'Товары'                                                          | '1 206 000'      | '01.01.2021'      | 'Нет'            | ''        | '1 326 600'       | ''                | 'Нет'            | ''        | '1 326 600'    | ''                | 'Нет'            | ''        | '0'     | ''                | 'Нет'            | ''        |
			| '1С:Управление холдингом 8 '                                      | '1 250 000'      | '01.01.2021'      | 'Да'             | '000001'  | '2 145 000'       | '02.05.2021'      | 'Да'             | '2000005' | '2 145 000'    | '02.05.2021'      | 'Да'             | '2000005' | '0'     | '01.01.2021'      | 'Нет'            | ''        |
			| '1С:Корпорация '                                                  | '2 050 000'      | '01.02.2021'      | 'Да'             | '000002'  | '2 255 000'       | ''                | 'Нет'            | ''        | '2 255 000'    | ''                | 'Нет'            | ''        | '0'     | ''                | 'Нет'            | ''        |
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) '           | '180 000'        | '01.03.2021'      | 'Да'             | '000003'  | '198 000'         | ''                | 'Нет'            | ''        | '198 000'      | ''                | 'Нет'            | ''        | '0'     | ''                | 'Нет'            | ''        |
			| '1С:ERP. Управление холдингом '                                   | '1 950 000'      | '01.04.2021'      | 'Да'             | '000004'  | '660 000'         | '02.01.2021'      | 'Да'             | '2000001' | '660 000'      | '02.01.2021'      | 'Да'             | '2000001' | '0'     | '02.01.2021'      | 'Нет'            | ''        |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест ' | '600 000'        | '01.05.2021'      | 'Да'             | '000005'  | '1 375 000'       | ''                | 'Нет'            | ''        | '1 375 000'    | ''                | 'Нет'            | ''        | '0'     | ''                | 'Нет'            | ''        |
	...
	* Смотрим расскрытие по дате
		...
		Тогда таблица 'РаскрытиеПоказателей' стала равной:
			| 'Номенклатура'                                                   | 'Значение1'  |
			| '1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64)'           | '01.03.2021' |
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '01.05.2021' |
			| '1С:ERP. Управление холдингом'                                   | '01.04.2021' |				
		И в таблице 'РаскрытиеПоказателей' я перехожу к строке:
			| 'Значение1'  | 'Номенклатура'                 |
			| '01.04.2021' | '1С:ERP. Управление холдингом' |
	...
	* Удаляем строку из формы раскрытия
		...
		И в таблице "РаскрытиеПоказателей" я перехожу к строке:
			...
			| '1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест' | '600 000,00000'      | '01.05.2021'         | 'Да'                 | '000005'             | '1 375 000,00000'    | 'Нет'                | '1 375 000,00000'    | 'Нет'                |
		И в таблице "РаскрытиеПоказателей" я нажимаю на кнопку с именем 'РаскрытиеПоказателейУдалить'
		И я нажимаю на кнопку с именем 'ФормаКнопкаОК'
	...
	* Сверяем результат
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
			...
			| ''                                      | 'Январь 2021 г.' | ''                | ''               | ''        | 'Февраль 2021 г.' | ''                | ''               | ''        | 'Март 2021 г.' | ''                | ''               | ''        | 'ИТОГО' | ''                | ''               | ''        |
			| ''                                      | 'Цена'           | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'            | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'         | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' | 'Цена'  | 'ДатаПоступления' | 'ВключатьВПрайс' | 'Артикул' |
			| 'Товары'                                | '1 950 000'      | ''                | 'Нет'            | ''        | '1 686 667'       | ''                | 'Нет'            | ''        | '1 686 667'    | ''                | 'Нет'            | ''        | '0'     | ''                | 'Нет'            | ''        |
			| '1С:Управление холдингом 8 '            | '0'              | ''                | 'Нет'            | ' '       | '2 145 000'       | '02.05.2021'      | 'Да'             | '2000005' | '2 145 000'    | '02.05.2021'      | 'Да'             | '2000005' | '0'     | ''                | 'Нет'            | ''        |
			| '1С:Корпорация '                        | '0'              | ''                | 'Нет'            | ''        | '2 255 000'       | ''                | 'Нет'            | ''        | '2 255 000'    | ''                | 'Нет'            | ''        | '0'     | ''                | 'Нет'            | ''        |
			| '1С:ERP. Управление холдингом '         | '1 950 000'      | ''                | 'Да'             | '000004'  | '660 000'         | '02.01.2021'      | 'Да'             | '2000001' | '660 000'      | '02.01.2021'      | 'Да'             | '2000001' | '0'     | ''                | 'Нет'            | ''        |
...
Сценарий: 07.05 Создание вида отчета "ВА - Нечисловые показатели (приемник)"
...
Сценарий: 07.06 Создание экземпляра отчета - "ВА - Нечисловые показатели (приемник)"  
...
Сценарий: 07.07 Расчет с удалением показателей
	...
	* Проверяем форму
		Тогда элемент формы с именем 'АналитикаОтчета1' стал равен "Реализация программных продуктов"
		...
		И Таблица 'ДополнительныеВалюты' содержит '2' строк из списка:
			...
			| 'EUR'      |
			| 'USD'      |		
		И элемент формы с именем 'ЗначениеКопирования' стал равен по шаблону "Экземпляр отчета *"
		И элемент формы с именем 'Организация' стал равен "Меркурий ООО"
		Тогда в таблице 'ПараметрыОтчета' количество строк "равно" 0
		И элемент формы с именем 'Периодичность' стал равен "Месяц"
		И элемент формы с именем 'ПериодОкончанияОтчета' стал равен "Март 2021 г."
		И элемент формы с именем 'ПериодОтчетаС' стал равен "Январь 2021 г."
		...
		И элемент формы с именем 'Регламент' стал равен "ВА - Основной регламент"
		И элемент формы с именем 'СпособВыводаФорма' стал равен "ВА - Нечисловые показатели (приемник)"
		И элемент формы с именем 'Сценарий' стал равен "ВА - Основной сценарий"
		И элемент формы с именем 'УправлениеПериодом' стал равен "Январь 2021 г. - Март 2021 г. (Периодичность: Месяц) <ВА - Основной сценарий>"

	* Меняем организацию
		И Я для реквизита 'Организация' устанавливаю значение "Венера ООО"
	...
	* Проверяем движения
		...
		И из выпадающего списка с именем "КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Значение" я выбираю точное значение "Да"
		...
		И из выпадающего списка с именем "КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Значение" я выбираю точное значение "Нет"
		И Я закрываю окно "Плоская таблица значений показателей"

Сценарий: 07.08 Создание вида отчета "ВА - Расчет в коде"
...
Сценарий: 07.09 Создание экземпляра отчета - "ВА - Расчет в коде" 
...
Сценарий: 07.10 Создание вида отчета "ВА - Группировка по аналитикам"
	...
	* Меняем настройки показателей
		* Сумма
			И я в конструкторе отчета в ячейке 'R2C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Сумма"
			И я в конструкторе отчета в ячейке 'R3C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Сумма"
			И я в конструкторе отчета в ячейке 'R3C2' меняю свойство показателя 'ВидИтога' на "Сумма"
			И я в конструкторе отчета в ячейке 'R4C2' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R4C2' меняю свойство показателя 'ВидИтога' на "Сумма"
		* Максимум
			И я в конструкторе отчета в ячейке 'R2C3' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R3C3' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Сумма"
			И я в конструкторе отчета в ячейке 'R3C3' меняю свойство показателя 'ВидИтога' на "Максимум"
			И я в конструкторе отчета в ячейке 'R4C3' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R4C3' меняю свойство показателя 'ВидИтога' на "Максимум"
		* Минимум
			И я в конструкторе отчета в ячейке 'R2C4' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R3C4' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Сумма"
			И я в конструкторе отчета в ячейке 'R3C4' меняю свойство показателя 'ВидИтога' на "Минимум"
			И я в конструкторе отчета в ячейке 'R4C4' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R3C4' меняю свойство показателя 'ВидИтога' на "Минимум"
		* Среднее
			И я в конструкторе отчета в ячейке 'R3C5' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Сумма"
			И я в конструкторе отчета в ячейке 'R3C5' меняю свойство показателя 'ВидИтога' на "Среднее"
			И я в конструкторе отчета в ячейке 'R4C5' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R4C5' меняю свойство показателя 'ВидИтога' на "Среднее"
		* БезИтога
			И я в конструкторе отчета в ячейке 'R2C6' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R3C6' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Сумма"
			И я в конструкторе отчета в ячейке 'R3C6' меняю свойство показателя 'ВидИтога' на "Итог по группе раскрытия не рассчитывается"
			И я в конструкторе отчета в ячейке 'R4C6' меняю свойство показателя 'СпособРасчетаИтогаПоПериоду' на "Итог по периоду не рассчитывается"
			И я в конструкторе отчета в ячейке 'R4C6' меняю свойство показателя 'ВидИтога' на "Итог по группе раскрытия не рассчитывается"
...
Сценарий: 07.11 Создание экземпляра отчета - "ВА - Группировка по аналитикам"
