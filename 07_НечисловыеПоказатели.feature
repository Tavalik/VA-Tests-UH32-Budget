...
Сценарий: 07.07 Создание экземпляра отчета - "ВА - Нечисловые показатели (источник)" 
	...
	* Сравниваем итоговый документ
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| ''                                                                | "Январь 2024 г." | ''                | ''               | ''        | "Февраль 2024 г." | ''                | ''               | ''        | "Март 2024 г." | ''                | ''               | ''        | "ИТОГО" | ''                | ''               | ''        |
			| ''                                                                | "Цена"           | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"            | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"         | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"  | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" |
			| "Товары"                                                          | '1 206 000'      | '01.01.2024'      | "Нет"            | ''        | '1 326 600'       | '02.01.2024'      | "Нет"            | ''        | '1 326 600'    | '02.01.2024'      | "Нет"            | ''        | '0'     | '01.01.2024'      | "Нет"            | ''        |
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.01.2024'      | "Да"             | '000001'  | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '0'     | '01.01.2024'      | "Нет"            | ''        |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.02.2024'      | "Да"             | '000002'  | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '0'     | '01.02.2024'      | "Нет"            | ''        |
			| "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) "           | '180 000'        | '01.03.2024'      | "Да"             | '000003'  | '198 000'         | ''                | "Нет"            | ''        | '198 000'      | ''                | "Нет"            | ''        | '0'     | '01.03.2024'      | "Нет"            | ''        |
			| "1С:ERP. Управление холдингом "                                   | '1 950 000'      | '01.04.2024'      | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '0'     | '02.01.2024'      | "Нет"            | ''        |
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.05.2024'      | "Да"             | '000005'  | '1 375 000'       | ''                | "Нет"            | ''        | '1 375 000'    | ''                | "Нет"            | ''        | '0'     | '01.05.2024'      | "Нет"            | ''        |
...
Сценарий: 07.08 Интерактивное удаление показателей
	...
	* Сверяем результат
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| ''                                                                | "Январь 2024 г." | ''                | ''               | ''        | "Февраль 2024 г." | ''                | ''               | ''        | "Март 2024 г." | ''                | ''               | ''        | "ИТОГО" | ''                | ''               | ''        |
			| ''                                                                | "Цена"           | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"            | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"         | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"  | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" |
			| "Товары"                                                          | '1 206 000'      | '01.01.2024'      | "Нет"            | ''        | '1 326 600'       | ''                | "Нет"            | ''        | '1 326 600'    | ''                | "Нет"            | ''        | '0'     | ''                | "Нет"            | ''        |
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.01.2024'      | "Да"             | '000001'  | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '0'     | '01.01.2024'      | "Нет"            | ''        |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.02.2024'      | "Да"             | '000002'  | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '0'     | ''                | "Нет"            | ''        |
			| "1С:Предприятие 8.3 КОРП. Лицензия на сервер (x86-64) "           | '180 000'        | '01.03.2024'      | "Да"             | '000003'  | '198 000'         | ''                | "Нет"            | ''        | '198 000'      | ''                | "Нет"            | ''        | '0'     | ''                | "Нет"            | ''        |
			| "1С:ERP. Управление холдингом "                                   | '1 950 000'      | '01.04.2024'      | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '0'     | '02.01.2024'      | "Нет"            | ''        |
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.05.2024'      | "Да"             | '000005'  | '1 375 000'       | ''                | "Нет"            | ''        | '1 375 000'    | ''                | "Нет"            | ''        | '0'     | ''                | "Нет"            | ''        |
	...
	* Сверяем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "1С:Управление холдингом 8 "            | '0'              | ''                | "Нет"            | ' '       | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '0'     | ''                | "Нет"            | ''        |
			| "1С:Корпорация "                        | '0'              | ''                | "Нет"            | ''        | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '0'     | ''                | "Нет"            | ''        |
			| "1С:ERP. Управление холдингом "         | '1 950 000'      | ''                | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '0'     | ''                | "Нет"            | ''        |
...
Сценарий: 07.10 Расчет с удалением показателей
	...
	* Проверяем форму
		...
		И элемент формы с именем 'ПериодОкончанияОтчета' стал равен "Март 2024 г."
		И элемент формы с именем 'ПериодОтчетаС' стал равен "Январь 2024 г."
	...
	* Проверяем движения
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "Макеты\07\ВА_НечисловыеПоказателиПриемник_Венера_Движения.mxl" по шаблону
...
Сценарий: 07.11 Создание экземпляра отчета - "ВА - Расчет в коде" 
	...
	* Рассчитываем документ и сверяем результат
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "Источник"                                                        | '6 030 000'      | '01.05.2024' | "Да"     | ''                                                                 | '6 633 000'       | '02.05.2024' | "Да"     | ''                                                                  | '6 633 000'    | '02.05.2024' | "Да"     | ''                                                               | '19 296 000' | '02.05.2024' | "Да"     | ''       |
			...
			| "ИсточникКод"                                                     | '6 030 000'      | '01.05.2024' | "Да"     | '000005'                                                           | '6 633 000'       | '02.05.2024' | "Да"     | '2000005'                                                           | '6 633 000'    | '02.05.2024' | "Да"     | '2000005'                                                        | '19 296 000' | '02.05.2024' | "Да"     | ''       |
			| "ПриемникКод"                                                     | '0'              | ''           | "Нет"    | ''                                                                 | '0'               | ''           | "Нет"    | ''                                                                  | '0'            | ''           | "Нет"    | ''                                                               | '0'          | ''           | "Нет"    | ''       |
			| "ФормулыКод"                                                      | '1'              | '01.12.2023' | "Да"     | "Меркурий ООО\nВА - Основной сценарий\nRUB\nЯнварь 2024 г.\nМесяц" | '2'               | '01.01.2024' | "Нет"    | "Меркурий ООО\nВА - Основной сценарий\nRUB\nФевраль 2024 г.\nМесяц" | '3'            | '01.02.2024' | "Нет"    | "Меркурий ООО\nВА - Основной сценарий\nRUB\nМарт 2024 г.\nМесяц" | '6'          | '01.02.2024' | "Да"     | ''       |
			| "Расчет"                                                          | '6 030 000'      | '01.06.2024' | "Нет"    | ''                                                                 | '13 266 000'      | '02.06.2024' | "Да"     | ''                                                                  | '19 899 000'   | '02.06.2024' | "Нет"    | ''                                                               | '39 195 000' | '02.06.2024' | "Да"     | ''       |
	...
	* Рассчитываем документ еще раз и сверяем изменившийся результат
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "1С:Предприятие 8 КОРП. Клиентская лицензия на 100 рабочих мест " | '600 000'        | '01.05.2024' | "Да"     | '000005'                                                           | '1 375 000'       | ''           | "Нет"    | ''                                                                  | '1 375 000'    | ''           | "Нет"    | ''                                                               | '3 350 000'  | '01.05.2024' | "Да"     | ''       |
			| "ИсточникКод"                                                     | '6 030 000'      | '01.05.2024' | "Да"     | '000005'                                                           | '6 633 000'       | '02.05.2024' | "Да"     | '2000005'                                                           | '6 633 000'    | '02.05.2024' | "Да"     | '2000005'                                                        | '19 296 000' | '02.05.2024' | "Да"     | ''       |
			| "ПриемникКод"                                                     | '6 030 000'      | '01.05.2024' | "Да"     | '000005'                                                           | '6 633 000'       | '02.05.2024' | "Да"     | '2000005'                                                           | '6 633 000'    | '02.05.2024' | "Да"     | '2000005'                                                        | '19 296 000' | '02.05.2024' | "Да"     | ''       |
			| "ФормулыКод"                                                      | '1'              | '01.12.2023' | "Да"     | "Меркурий ООО\nВА - Основной сценарий\nRUB\nЯнварь 2024 г.\nМесяц" | '2'               | '01.01.2024' | "Нет"    | "Меркурий ООО\nВА - Основной сценарий\nRUB\nФевраль 2024 г.\nМесяц" | '3'            | '01.02.2024' | "Нет"    | "Меркурий ООО\nВА - Основной сценарий\nRUB\nМарт 2024 г.\nМесяц" | '6'          | '01.02.2024' | "Да"     | ''       |
			| "Расчет"                                                          | '6 030 000'      | '01.06.2024' | "Нет"    | ''                                                                 | '13 266 000'      | '02.06.2024' | "Да"     | ''                                                                  | '19 899 000'   | '02.06.2024' | "Нет"    | ''                                                               | '39 195 000' | '02.06.2024' | "Да"     | ''       |
			| "1С:Управление холдингом 8 "                                      | '1 250 000'      | '01.02.2024' | "Нет"    | '!!! 000001'                                                       | '4 290 000'       | '02.06.2024' | "Нет"    | '!!! 2000005'                                                       | '6 435 000'    | '02.06.2024' | "Нет"    | '!!! 2000005'                                                    | '11 975 000' | '02.06.2024' | "Нет"    | ''       |
			| "1С:Корпорация "                                                  | '2 050 000'      | '01.03.2024' | "Нет"    | '!!! 000002'                                                       | '4 510 000'       | ''           | "Да"     | ''                                                                  | '6 765 000'    | ''           | "Нет"    | ''                                                               | '13 325 000' | '01.03.2024' | "Да"     | ''       |
