...
Сценарий: 04.02 Проверка поведения формы настройки показателей
	...
	* Проверяем заполнение таблиц
		...
		Тогда Таблица 'ДеревоПолейБД' стала равной или содержит строки:				
			| "Поле"                     |
			| "Параметры запроса(3)"     |
			| 'ПериодНачала'             |
			| 'ПериодОкончания'          |
			...
			| 'Номенклатура'             |
			| 'Цена'                     |
		Тогда Таблица 'ТаблицаСоответствия' стала равной или содержит строки:
		...
		Когда открылось окно "Источник данных (создание) *"
		Тогда Таблица 'ДеревоПараметровОтбораБД' стала равной или содержит строки:
