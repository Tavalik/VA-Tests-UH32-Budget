...
Сценарий: 11.01 Создание группы отчетов "ВА - Правила расчета (группа)"

	И Я создаю группу видов отчетов с именем "ВА - Правила расчета (группа)" и родителем "ВА - Группа отчетов"

Сценарий: 11.02 Создание отчета с ручным вводом - "ВА - Количество"
...
Сценарий: 11.04 Создание отчета с загрузкой из РС "ВА - Цена"
...
Сценарий: 11.06 Создание отчета с рассчитываемыми показателями - "ВА - Продажи"
...
Сценарий: 11.07 Создание экземпляра отчета - "ВА - Продажи"	- пишем черновые версии
