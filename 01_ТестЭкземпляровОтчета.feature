...
Сценарий: 01.22 Тестируем экземпляр отчета с бланком сводной таблицы
	...
	* Меняем параметры отображения в экземпляре отчета
		...
		Тогда открылось окно "Редактирование настроек отчета"
		И я перехожу к закладке с именем 'ГруппаСтраницаНастройкиОтчета'
		И из выпадающего списка с именем 'СпособВыводаФорма' я выбираю точное значение "ВА - Ручной ввод по всем аналитикам (сводная таблица)"
		И я нажимаю на кнопку с именем 'ФормаПрименитьИЗакрыть'
	...
	* Сравниваем результат
		Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету 'ВА_ВидОтчетаСАналитиками_Венера_СводнаяТаблица1'
	...
	* Настраиваем свойства
		...
		* Сравниваем результат
			Когда открылось окно '$ЗаголовокОкна$'	
			Дано Табличный документ 'ПолеТабличногоДокументаМакет' равен макету 'ВА_ВидОтчетаСАналитиками_Венера_СводнаяТаблица2'	
...
Сценарий: 01.23 Переходим в режим отображения данных
...
Сценарий: 01.24 Тестируем кнопки пересчета показателей
