...
Сценарий: 01.11 Проверяем движения документа
	...
	* Проверяем движения документа
		Когда открылось окно '$ЗаголовокОкна$'
		И Движения документа стали равны '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Меркурий_Движения.mxl' область чтения "R1C1:R708C11"
...
Сценарий: 01.12 Копирование экземпляра отчета
	...
	* Проверяем движения документа
		Когда открылось окно '$ЗаголовокОкна$'
		И Движения документа стали равны '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Венера_Движения.mxl' область чтения "R1C1:R694C12"
...
Сценарий: 01.13 Проверяем форму создания документа ЭО
	...
	* Все настройки должны подтянуться из хранилища настроек
		...
		И элемент формы с именем 'БланкИмпорта' стал равен "ВА - Ручной ввод по всем аналитикам"
		...
		И элемент формы с именем 'Организация' стал равен "Венера ООО"
	...
	* Меняем реквизиты
		...
		И я устанавливаю флаг с именем 'ИндивидуальныеНастройки'
		Тогда открылось окно "1С:Предприятие"
		И я нажимаю на кнопку с именем 'Button0'
		Тогда открылось окно "Укажите ключевые реквизиты документа *"
		И выпадающий список с именем 'СпособФормированияОтчета' стал равен:
	...
	* Смотрим настройки документа	
		...
		И элемент формы с именем 'ИндивидуальныеНастройки' стал равен "Да"
	...
	* Сверяем движения
		И Движения документа с реквизитами стали равны '\\Макеты\01\ВА_ВидОтчетаСАналитиками_Система_Пропорционально_Движения.mxl' область чтения "R1C1:R236C19"		
