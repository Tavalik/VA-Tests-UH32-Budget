...
Сценарий: 01.10 Копирование экземпляра отчета
	...
	* Копирование экземпляра
		...
		Если '$$ЭтоУХ$$' Тогда
			И Я в списке "Организационные единицы" по полю "Наименование в программе" ищу элемент "Земля ООО" "По точному совпадению"
		Если '$$ЭтоЕРПУХ$$' Тогда
			И Я в списке "Организации" по полю "Рабочее наименование" ищу элемент "Земля ООО" "По точному совпадению"
		Когда открылось окно "Укажите ключевые реквизиты документа"
		И я нажимаю на кнопку с именем 'КнопкаОК'
...
Сценарий: 01.11 Консолидация периметра
	...
	* Создаем документ
		И Я создаю экземпляр отчета для вида отчета "ВА - Ручной ввод по всем аналитикам" сценарий "ВА - Основной сценарий" период '01.01.2021' '31.03.2021' периодичность "Месяц" организация "Система ООО" проект "ВА - Основной проект" аналитики '' '' '' '' '' ''
	...
	* Проверяем периодичность в "Свернуть по периоду"
		...
		И элемент формы с именем 'ПериодичностьСвертки' стал равен "Декада"
...
Сценарий: 01.12 Эллиминация и форма выбора расчета показателей
	...
	* Создаем документ
		И Я создаю экземпляр отчета для вида отчета "ВА - Ручной ввод по всем аналитикам" сценарий "ВА - Основной сценарий" период '01.01.2021' '31.03.2021' периодичность "Месяц" организация "Марс ООО" проект "ВА - Основной проект" аналитики '' '' '' '' '' ''
