...
Сценарий: 00.05 Создание пользователя "Администратор"
	...
	И Я нахожу или создаю пользователя "Администратор" с языком отчетности "Русский"
...
Сценарий: 00.06 Создание пользователя "Бюджетирование1"

	И Я нахожу или создаю пользователя "Бюджетирование1" с языком отчетности "Русский"

	Когда открылось окно "Бюджетирование1 (Пользователь)"
	И В текущем окне я нажимаю кнопку командного интерфейса "Права доступа"
	...
	* Группа "Работа с настраиваемой отчетностью"
		И в таблице 'ГруппыДоступа' я нажимаю на кнопку с именем 'ГруппыДоступаВключитьВГруппу'
		Тогда открылось окно "Группы доступа"
		И в таблице 'ГруппыДоступа' я перехожу к строке:
			| "Наименование"    |
