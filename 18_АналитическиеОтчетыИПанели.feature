...
Функционал: Тестирование Аналитических отчетов и панелей
...
Сценарий: 18.01 Создание вида отчета
...
Сценарий: 18.02 Создание аналитических отчетов

	И Я создаю группу аналитических отчетов с именем "ВА - Аналитические отчеты" родителем ''

	И Я создаю аналитический отчет с кодом '100000000001' вид отчета "ВА - Аналитические отчеты" период "Январь 2021 г." организация "Меркурий ООО" родитель "ВА - Аналитические отчеты"
	И Я создаю аналитический отчет с кодом '100000000002' вид отчета"ВА - Аналитические отчеты" период "Январь 2021 г." организация "Система ООО" родитель "ВА - Аналитические отчеты"

Сценарий: 18.03 Создание аналитической панели
...
Сценарий: 18.04 Настройка прав для пользователя "Бюджетирование1"
...
Сценарий: 18.05 Создание экземпляров отчетов

	И Я создаю экземпляр отчета для вида отчета "ВА - Аналитические отчеты" сценарий "ВА - Основной сценарий" период '01.01.2021' '31.03.2021' периодичность "Месяц" организация "Меркурий ООО" проект '' аналитики '' '' '' '' '' ''
	...
	И Я создаю экземпляр отчета для вида отчета "ВА - Аналитические отчеты" сценарий "ВА - Основной сценарий" период '01.01.2021' '31.03.2021' периодичность "Месяц" организация "Система ООО" проект '' аналитики '' '' '' '' '' ''
...
Сценарий: 18.06 Просмотр аналитических отчетов
	...
	И табличный документ 'Результат' равен макету "Макеты\ВА_АналитическийОтчет.mxl" по шаблону
...
Сценарий: 18.07 Просмотр аналитических панелей		

	И В командном интерфейсе я выбираю "Бюджетирование, отчетность и анализ" "Аналитические панели"
	И Я в списке "Аналитические панели" по полю "Аналитическая панель" ищу элемент "ВА - Аналитические отчеты" "По началу строки" 
	И я нажимаю на кнопку с именем 'ФормаОтобразитьПанель'

	И табличный документ 'Код_100000000001_1_Окно' равен макету "Макеты\ВА_АналитическийОтчет.mxl" по шаблону
	И табличный документ 'Код_100000000002_2_Окно' равен макету "Макеты\ВА_АналитическийОтчет.mxl" по шаблону
