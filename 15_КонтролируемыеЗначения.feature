...
Сценарий: 15.04 Создаем экземпляра отчета для контролируемых значений
	...
	* Копируем существующий документ
		...
		Тогда Открылся экземпляр отчета для вида отчета "ВА - Контролируемые показатели" валюта 'RUB' организация "Меркурий ООО" сценарий "ВА - Основной сценарий" периодичность "Месяц" проект "ВА - Основной проект" аналитики '' '' '' '' '' '' 
