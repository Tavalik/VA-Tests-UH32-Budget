...
Сценарий: 15.01 Создание вида отчета "ВА - Контролируемые показатели"
	...
	* Настраиваем показатели
		И Я в конструкторе отчета в ячейке 'R2C2:R3C5' я меняю свойства показателей 'КонтролируемыйПоказатель' на "Истина"	
		И Я в конструкторе отчета в ячейке 'R2C2' я меняю свойства показателей 'КонтролируемыйПоказатель' на "Ложь"
		И я в конструкторе отчета в ячейке 'R3C2' я меняю свойство показателя 'КонтролируемыйПоказатель' на "Ложь"
	...
	* Бланк вида отчета
		И Я Для вида отчета "ВА - Контролируемые показатели" я создаю бланк по умолчанию		
...
Сценарий: 15.04 Создаем экземпляра отчета для контролируемых значений
	...
	* Копируем существующий документ
		...
		Если '$$ЭтоУХ$$' Тогда
			И Я в списке "Организационные единицы" по полю "Наименование в программе" ищу элемент "Меркурий ООО" "По точному совпадению"
		Если '$$ЭтоЕРПУХ$$' Тогда
			И Я в списке "Организации" по полю "Рабочее наименование" ищу элемент "Меркурий ООО" "По точному совпадению"
		Когда открылось окно "Укажите ключевые реквизиты документа"
	...
	* Записываем документ
		...
		Затем я жду, что в сообщениях пользователю будет подстрока "Не удалось записать данные экземпляра отчета по причине:" в течение 30 секунд
...
Сценарий: 15.04 Создаем сводную таблицу для контролируемых значений 						
	...
	* Создаем бланк сводной таблицы
		И Я для вида отчета "ВА - Контролируемые показатели" я создаю бланк сводной таблицы по умолчанию с отборами "Проект"
