...
Сценарий: 15.01 Создание вида отчета "ВА - Контролируемые показатели"
	...
	* Настраиваем показатели
		...
		И я в конструкторе отчета в ячейке 'R2C5:R3C5' меняю свойство показателя 'ВидИтогда' на "Минимум"
...
Сценарий: 15.04 Создание экземпляра отчета "ВА - Контролируемые показатели"
	...
	* Записываем, проверяем форму
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| "Синтетика"                         | '100'            | '100'        | '100'         | '01.01.2024' | '200'             | '200'        | '200'         | '01.01.2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | ''     |
	...
	* Обновляем и проверяем форму
		...
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| ''                                  | "Количество"     | "КонтрольДа" | "КонтрольНет" | "Дата"       | "Количество"      | "КонтрольДа" | "КонтрольНет" | "Дата"       | "Количество"   | "КонтрольДа" | "КонтрольНет" | "Дата" | "Количество" | "КонтрольДа" | "КонтрольНет" | "Дата" |
			| "Синтетика"                         | '100'            | '100'        | '100'         | '01.01.2024' | '200'             | '200'        | '200'         | '01.01.2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | ''     |
			| "Аналитики"                         | '200'            | '200'        | '200'         | '01.01.2024' | '400'             | '400'        | '400'         | '01.02.2024' | '0'            | '0'          | '0'           | ''     | '600'        | '600'        | '600'         | ''     |
			| "Реализация программных продуктов " | '200'            | '200'        | '200'         | '01.01.2024' | '400'             | '400'        | '400'         | '01.02.2024' | '0'            | '0'          | '0'           | ''     | '600'        | '600'        | '600'         | ''     |
			| "1С:Корпорация "                    | '100'            | '100'        | '100'         | '01.01.2024' | '200'             | '200'        | '200'         | '01.02.2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | ''     |
			| 'RUB '                              | '100'            | '100'        | '100'         | '01.01.2024' | '200'             | '200'        | '200'         | '01.02.2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | ''     |
			| "1С:Управление холдингом 8 "        | '100'            | '100'        | '100'         | '01.01.2024' | '200'             | '200'        | '200'         | '01.02.2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | ''     |
			| 'RUB '                              | '100'            | '100'        | '100'         | '01.01.2024' | '200'             | '200'        | '200'         | '01.02.2024' | '0'            | '0'          | '0'           | ''     | '300'        | '300'        | '300'         | ''     |
