...
Сценарий: 15.04 Создаем экземпляра отчета для контролируемых значений
	...
	* Копируем существующий документ
		...
		Если '$$ЭтоУХ$$' Тогда
			И Я в списке "Организационные единицы" по полю "Наименование в программе" ищу и выбираю элемент "Меркурий ООО" "По точному совпадению"
		Если '$$ЭтоЕРПУХ$$' Тогда
			И Я в списке "Организации" по полю "Рабочее наименование" ищу и выбираю элемент "Меркурий ООО" "По точному совпадению"
		Когда открылось окно "Укажите ключевые реквизиты документа"
