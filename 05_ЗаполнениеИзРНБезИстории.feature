	...
	Если 'НЕ $$ЭтоPerform$$' Тогда
		...
		* Записываем документ, проверяем движения
			...
			Тогда табличный документ 'ОтчетТабличныйДокумент' равен по шаблону:
				...
				| 'Статьи ДДС сумма'                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'RUB'    | '3 120 000,00000'                  | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'USD'    | '42 036,96019'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'EUR'    | '34 476,24288'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | '16 000 000,00000'                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | '215 126,9181*'                    | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | '177 912,00250'                    | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| ''                                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				...
				| 'Статьи ДДС сумма'                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'RUB'    | "Внедрение программных продуктов"  | ''                 | '2 340 000,00000'  | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'RUB'    | "Реализация программных продуктов" | ''                 | '780 000,00000'    | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'USD'    | "Внедрение программных продуктов"  | ''                 | '31 527,72014'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'USD'    | "Реализация программных продуктов" | ''                 | '10 509,24005'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'EUR'    | "Внедрение программных продуктов"  | ''                 | '25 857,18216'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Январь 2024 г."                                     | 'EUR'    | "Реализация программных продуктов" | ''                 | '8 619,06072'      | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | "Апгрейд программных продуктов"    | ''                 | '3 450 000,00000'  | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | "Внедрение программных продуктов"  | ''                 | '7 350 000,00000'  | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | "Реализация программных продуктов" | ''                 | '5 200 000,00000'  | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | "Апгрейд программных продуктов"    | ''                 | '46 386,7417*'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | "Внедрение программных продуктов"  | ''                 | '98 823,9280*'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | "Реализация программных продуктов" | ''                 | '69 916,24840'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | "Апгрейд программных продуктов"    | ''                 | '38 362,27554'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | "Внедрение программных продуктов"  | ''                 | '81 728,32615'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | "Реализация программных продуктов" | ''                 | '57 821,40081'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| ''                                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
	...
	Если 'НЕ $$ЭтоPerform$$' Тогда
		...
		* Проверяем, движения после сводной таблицы
			...
			Тогда табличный документ 'ОтчетТабличныйДокумент' равен по шаблону:
				...
				| 'Версия'                                  | "Период отчета"                                      | 'Валюта' | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| 'Статьи ДДС сумма'                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | '3 120 000,00000'                  | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | '41 949,7490*'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | '34 692,84049'                     | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| ''                                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| "Значения показателей отчетов валютные"   | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| ''                                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| 'Показатель'                              | ''                                                   | ''       | ''                                 | 'Значение'         | 'Значение валюта'  | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				...
				| 'Версия'                                  | "Период отчета"                                      | 'Валюта' | 'Аналитика 1'                      | 'Аналитика валюта' | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| 'Статьи ДДС сумма'                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | "Внедрение программных продуктов"  | ''                 | '2 340 000,00000'  | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'RUB'    | "Реализация программных продуктов" | ''                 | '780 000,00000'    | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | "Внедрение программных продуктов"  | ''                 | '31 462,3117*'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'USD'    | "Реализация программных продуктов" | ''                 | '10 487,43726'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | "Внедрение программных продуктов"  | ''                 | '26 019,63037'     | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| '*'                                       | "Февраль 2024 г."                                    | 'EUR'    | "Реализация программных продуктов" | ''                 | '8 673,21012'      | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| ''                                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| "Значения показателей отчетов 2"          | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| ''                                        | ''                                                   | ''       | ''                                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                 | ''                    | ''                |
				| 'Показатель'                              | ''                                                   | ''       | ''                                 | ''                 | ''                 | 'Значение'         | 'Значение валюта'  | ''                 | ''                 | ''                    | ''                |
