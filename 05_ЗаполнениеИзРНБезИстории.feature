...
Сценарий: 05.05 Создание экземпляра отчета - "ВА - Заполнение из РН (без истории)" с записью 
	...
	Если 'НЕ $$ЭтоPerform$$' Тогда
		...
		* Проверяем движения
			И Движения документа стали равны '\Макеты\05\ВА_ЗаполнениеИзРН_Движения_1.mxl' область чтения "R1C1:R75C12"
...
Сценарий: 05.09 Проверяем движения экземпляра отчета
	...
	Если 'НЕ $$ЭтоPerform$$' Тогда
		...
		* Проверяем движения
			...
			И я нажимаю на кнопку с именем 'Записать'
			И я жду открытия формы '$ЗаголовокОкна$' в течение 30 секунд
			И Движения документа с реквизитами стали равны '\Макеты\05\ВА_ЗаполнениеИзРН_Движения_2.mxl' область чтения "R1C1:R72C14"
