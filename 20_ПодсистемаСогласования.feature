...
Сценарий: 20.09 Согласование по пользователеми
	...
	* Согласование 1 (часть 1)
		...
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\20\ВА_ТестированиеСогласованияЭтап1_Меркурий.mxl" по шаблону
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\20\ВА_ТестированиеСогласованияЭтап2_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование3 (заместитель)
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\20\ВА_ТестированиеСогласованияЭтап4_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование 2
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\20\ВА_ТестированиеСогласованияЭтап3_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
	...
	* Согласование 4
		...
		Тогда открылось окно '$ЗаголовокОкна$'
		И я нажимаю на кнопку с именем 'МаршрутСогласования'
		И табличный документ 'ТабДокПроцесса' содержит строки из макета "Макеты\20\ВА_ТестированиеСогласованияАвтоутверждение_Меркурий.mxl" по шаблону
		И Я закрываю окно "Согласование: Экземпляр отчета * от *"
